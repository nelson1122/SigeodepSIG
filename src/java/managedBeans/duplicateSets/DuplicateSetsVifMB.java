...
public class DuplicateSetsVifMB implements Serializable {
    ...
    public void loadDuplicatedRecords() {
        ...
        if (selectedRowDuplicatedTable != null) {
            try {
                ...
                RowDataTable newRow = connectionJdbcMB.loadNonFatalDomesticViolenceRecord(selectedRowDuplicatedTable.getColumn1());
                if (newRow == null) {
                    ...
                    while (resultSetCount.next()) {
                        cont++;
                        rowDataTableList.add(connectionJdbcMB.loadNonFatalDomesticViolenceRecord(resultSetCount.getString("victim_id")));
                    }
                    if (cont == 0) {
    ...
    public void loadValues(RowDataTable[] selectedRowsDataTableTags) {
        ...
        rowDataTableList = new ArrayList<>();
        data = "- ";
        //CREO LA LISTA DE CARGAS SELECCIONADOS
    ...
    public void deleteRegistry() {
        if (selectedRowDataTable != null) {
            NonFatalInjuries nonFatalInjurySelect = nonFatalInjuriesFacade.find(Integer.parseInt(selectedRowDataTable.getColumn1()));
            if (nonFatalInjurySelect != null) {
                ...
                if (nonFatalInjurySelect.getNonFatalDomesticViolence() != null) {
                    auxDomesticViolence = nonFatalInjurySelect.getNonFatalDomesticViolence();
                    auxSivigilaEvent = nonFatalInjurySelect.getNonFatalDomesticViolence().getSivigilaEvent();
                ...
                if (nonFatalInjurySelect.getNonFatalInterpersonal() != null) {
                    nonFatalInterpersonalFacade.remove(nonFatalInjurySelect.getNonFatalInterpersonal());
                }
                if (nonFatalInjurySelect.getNonFatalSelfInflicted() != null) {
                    nonFatalSelfInflictedFacade.remove(nonFatalInjurySelect.getNonFatalSelfInflicted());
                }
                if (nonFatalInjurySelect.getNonFatalTransport() != null) {
                    nonFatalTransportFacade.remove(nonFatalInjurySelect.getNonFatalTransport());
                }
                if (auxSivigilaEvent != null) {
                ...
                nonFatalInjuriesFacade.remove(nonFatalInjurySelect);

                if (nonFatalInjurySelect.getVictimId() != null) {
                    victimsFacade.remove(nonFatalInjurySelect.getVictimId());
                }
            ...
            //quito los elementos seleccionados de rowsDataTableList
