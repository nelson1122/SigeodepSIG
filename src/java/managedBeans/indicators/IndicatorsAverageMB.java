...
/**
 * This class is responsible for calculating the average case of an injury to a
 * reference period, providing characteristic values of a type of lesion based
 * to a temporal disaggregation.
 *
 * @author SANTOS
 */
...
public class IndicatorsAverageMB {
    ...
    /**
     * This method stores in database the records of the cross being realize,
     * records are stored in the table indicators_records
     *
     * @param sqlConsult
     */
...
//                valuesConf.add("VIOLENCIA INTRAFAMILIAR");
    ...
    /**
     * This method is responsible of create the bar graph which shows the
     * results of cross of variables.
     *
     * @return
     */
