...
(function (root, factory) {
    ...
    var za = /&/g, Ba = /</g, Ca = />/g, Ea = /"/g, Fa = /'/g, Ga = /\x00/g, ya = /[\x00&<>"']/, Ha = String.prototype.repeat ? function (a, c) {
        return a.repeat(c)
    } : function (a, c) {
        return Array(c + 1).join(a)
    };
    function Ja(a, c) {
        var d = ba(c) ? a.toFixed(c) : String(a), e = d.indexOf(".");
        -1 == e && (e = d.length);
    ...
    function rb(a) {
        function c(c) {
            var e = a.listener, f = a.dg || a.target;
            a.fg && sb(a);
            return e.call(f, c)
        }
        return a.eg = c
    ...
    ;
    var Tb = Array.prototype, Ub = Tb.indexOf ? function (a, c, d) {
        ...
        for (var e = a.length, f = ha(a) ? a.split("") : a, g = 0; g < e; g++)
    ...
    function sc(a, c, d) {
        var e = a[0], f = a[1], g = a[2], h = a[3], k = a[4], m = a[5], n = a[6], p = a[7], q = a[8], r = a[9], t = a[10], v = a[11], w = a[12], z = a[13], C = a[14];
        a = a[15];
        var A = c[0], B = c[1], L = c[2], J = c[3], M = c[4], P = c[5], Aa = c[6], I = c[7], ca = c[8], Da = c[9], Ia = c[10], ab = c[11], Pa = c[12], Ec = c[13], Uc = c[14];
        c = c[15];
        d[0] = e * A + k * B + q * L + w * J;
        d[1] = f * A + m * B + r * L + z * J;
        d[2] = g * A + n * B + t * L + C * J;
    ...
    function tc(a, c) {
        var d = a[0], e = a[1], f = a[2], g = a[3], h = a[4], k = a[5], m = a[6], n = a[7], p = a[8], q = a[9], r = a[10], t = a[11], v = a[12], w = a[13], z = a[14], C = a[15], A = d * k - e * h, B = d * m - f * h, L = d * n - g * h, J = e * m - f * k, M = e * n - g * k, P = f * n - g * m, Aa = p * w - q * v, I = p * z - r * v, ca = p * C - t * v, Da = q * z - r * w, Ia = q * C - t * w, ab = r * C - t * z, Pa = A * ab - B * Ia + L * Da + J * ca - M * I + P * Aa;
    ...
    new Float64Array(16);
    function xc(a) {
        for (var c = yc(), d = 0, e = a.length; d < e; ++d)
            zc(c, a[d]);
        return c
    }
    function Ac(a, c, d) {
    ...
    var ed = dd(!1), fd = dd(!0), gd = dd(null);
    function hd(a) {
        return a
    }
    function id(a) {
    ...
    kd.prototype.a = function (a) {
        for (var c = 0, d = a.length, e = a[d - 1][0], f = a[d - 1][1], g = 0; g < d; g++)
            var h = a[g][0], k = a[g][1], c = c + Ra(h - e) * (2 + Math.sin(Ra(f)) + Math.sin(Ra(k))), e = h, f = k;
        return c * this.radius * this.radius / 2
    };
    kd.prototype.b = function (a, c) {
        var d = Ra(a[1]), e = Ra(c[1]), f = (e - d) / 2, g = Ra(c[0] - a[0]) / 2, d = Math.sin(f) * Math.sin(f) + Math.sin(g) * Math.sin(g) * Math.cos(d) * Math.cos(e);
    ...
    function nd(a) {
        ...
        var c = od, d = a.code, e = pd || aa.proj4;
    ...
    l.Xj = function (a, c) {
        if ("degrees" == this.a)
            return a;
        var d = ud(this, qd("EPSG:4326")), e = [c[0] - a / 2, c[1], c[0] + a / 2, c[1], c[0], c[1] - a / 2, c[0], c[1] + a / 2], e = d(e, e, 2), d = ld.b(e.slice(0, 2), e.slice(2, 4)), e = ld.b(e.slice(4, 6), e.slice(6, 8)), e = (d + e) / 2, d = this.$b();
        void 0 !== d && (e /= d);
        return e
    };
    ...
    l.Rc = function (a, c) {
        var d = this.ga();
        if (d) {
            var e = d.length, f = this.qa(), g = d ? d : [], h = 0, k, m;
            for (k = 0; k < e; k += f)
    ...
    function Vd(a, c, d, e, f) {
        var g = a[c], h = a[c + 1];
        for (c += e; c < d; c += e) {
            var k = a[c], m = a[c + 1], g = Qa(g, h, k, m);
            g > f && (f = g);
            g = k;
            h = m
        }
    ...
    function de(a, c, d, e, f, g, h) {
        ...
        for (var n = 0, p; 0 < d.length; ) {
            var q = d.pop(), r = d.pop(), t = 0, v = a[r], w = a[r + 1], z = a[q], C = a[q + 1];
            for (p = r + e; p < q; p += e) {
    ...
    function ee(a, c, d, e, f, g, h, k) {
        ...
        for (n = d.length; m < n; ++m) {
            ...
            a:{
                ...
                if (c != r) {
                    var z = v * Math.round(q[c] / v), C = v * Math.round(q[c + 1] / v);
                    c += t;
                    w[h++] = z;
                    w[h++] = C;
    ...
    function me(a, c, d, e, f) {
        ...
        return ad(f, g) ? Gc(f, g) || g[0] >= f[0] && g[2] <= f[2] || g[1] >= f[1] && g[3] <= f[3] ? !0 : le(a, c, d, e, function (a, c) {
            var d = !1, e = Hc(f, a), g = Hc(f, c);
            if (1 === e || 1 === g)
                d = !0;
            else {
                var q = f[0], r = f[1], t = f[2], v = f[3], w = c[0], z = c[1], C = (z - a[1]) / (w - a[0]);
    ...
    l.Vd = function () {
        var a = this.f, c = this.v, d = this.c, e = [], f = 0, g, h;
        g = 0;
        for (h = d.length; g < h; ++g) {
            var k = d[g], m = new fe(null);
            ge(m, a, c.slice(f, k));
            e.push(m);
            f = k
        }
    ...
    function we(a, c, d, e) {
        var f = a.ga(), g = a.f, h = a.qa(), k = a.Cb(), m = f.length / h - 1;
        e = e ? e : 0;
    ...
    function xe(a) {
        ...
        if (void 0 !== a.resolutions)
            ...
            e = Fd(a.projection);
            f = e.G();
            var k = (f ? Math.max(Wc(f), Xc(f)) : 360 * md.degrees / e.$b()) / 256 / Math.pow(2, 0), m = k / Math.pow(2, 28);
            e = a.maxResolution;
    ...
    l.bd = function (a) {
        var c = this.Wa(), d = this.Z(), e = this.Ka();
        return Zc(c, d, e, a)
    };
    l.yl = function () {
        return this.i
    ...
    function ye(a) {
        var c = a.a, d = Math.log(c / a.l) / Math.log(2);
        return function (a) {
    ...
    l.V = function () {
        var a = this.Wa(), c = this.i, d = this.Z(), e = this.Ka();
    ...
    l.Xe = function (a, c, d) {
        ...
        for (var t = 0, v = k.length; t < v; t += a)
            var w = k[t] * e - k[t + 1] * m, z = k[t] * m + k[t + 1] * e,
                n = Math.min(n, w), p = Math.min(p, z), q = Math.max(q, w), r = Math.max(r, z);
        k = [n, p, q, r];
    ...
    ;
    function He(a) {
        var c = a.source, d = a.start ? a.start : Date.now(), e = c[0], f = c[1], g = void 0 !== a.duration ? a.duration : 1E3, h = a.easing ? a.easing : Ee;
        return function (a, c) {
            if (c.time < d)
    ...
    function Ie(a) {
        var c = a.rotation ? a.rotation : 0, d = a.start ? a.start : Date.now(), e = void 0 !== a.duration ? a.duration : 1E3, f = a.easing ? a.easing : Ee, g = a.anchor ? a.anchor : null;
        return function (a, k) {
            if (k.time < d)
    ...
    function Je(a) {
        var c = a.resolution, d = a.start ? a.start : Date.now(), e = void 0 !== a.duration ? a.duration : 1E3, f = a.easing ? a.easing : Ee;
        return function (a, h) {
            if (h.time < d)
    ...
    ;
    var Ue = /^#(?:[0-9a-f]{3}){1,2}$/i, Ve = /^(?:rgb)?\((0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2})\)$/i, We = /^(?:rgba)?\((0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2}),\s?(0|1|0\.\d{0,10})\)$/i;
    function Xe(a) {
        return fa(a) ? a : Ye(a)
    }
    function Ze(a) {
    ...
    ;
    var jf = ef("Opera") || ef("OPR"), kf = ef("Trident") || ef("MSIE"), lf = ef("Edge"), mf = ef("Gecko") && !(-1 != bf.toLowerCase().indexOf("webkit") && !ef("Edge")) && !(ef("Trident") || ef("MSIE")) && !ef("Edge"), nf = -1 != bf.toLowerCase().indexOf("webkit") && !ef("Edge");
    function of() {
        var a = bf;
        if (mf)
            return/rv\:([^\);]+)(\)|;)/.exec(a);
    ...
    var tf = aa.document, uf = tf && kf ? pf() || ("CSS1Compat" == tf.compatMode ? parseInt(qf, 10) : 5) : void 0;
    var vf = !kf || 9 <= uf;
    ...
    function ag(a) {
        var c = a.offsetWidth, d = a.offsetHeight, e = nf && !c && !d;
    ...
    function eg(a, c) {
        if (kf) {
            var d = dg(a, c + "Left"), e = dg(a, c + "Right"), f = dg(a, c + "Top"), g = dg(a, c + "Bottom");
    ...
    function hg(a) {
        if (kf && !(9 <= uf)) {
            var c = gg(a, "borderLeft"), d = gg(a, "borderRight"), e = gg(a, "borderTop");
            a = gg(a, "borderBottom");
    ...
    function og(a, c) {
        for (var d, e; ng(a) && !(d = a.b.mc, e = d.ja[0].toString(), e in c && c[e].contains(d.ja)); )
            a.pop().Rd()
    }
    ;
    function pg(a, c) {
    ...
    function Cg(a, c) {
        var d = a.Ha(c[0]), e = a.Z(c[0]), f = Sb(a.Ua(c[0]), a.f);
        return[d[0] + (c[1] + .5) * f[0] * e, d[1] + (c[2] + .5) * f[1] * e]
    }
    l.Da = function (a, c) {
        var d = this.Ha(a[0]), e = this.Z(a[0]), f = Sb(this.Ua(a[0]), this.f), g = d[0] + a[1] * f[0] * e, d = d[1] + a[2] * f[1] * e;
    ...
    function Bg(a, c, d, e, f, g) {
        var h = Dg(a, e), k = e / a.Z(h), m = a.Ha(h);
        a = Sb(a.Ua(h), a.f);
    ...
    function Eg(a) {
        var c = a.j;
        if (!c) {
            var c = Fg(a), d = Gg(c, void 0, void 0), c = new ug({extent: c, origin: Sc(c), resolutions: d, tileSize: void 0});
            a.j = c
        }
        return c
    }
    ...
    ;
    function Ig(a) {
        rg.call(this, {attributions: a.attributions, extent: a.extent, logo: a.logo, projection: a.projection, state: a.state, wrapX: a.wrapX});
    ...
    function Og(a) {
        if (a = a.frameState) {
                            ...
                            if (k = n[e], m = x(k).toString(), !(m in t)) {
                                if (g = a.usedTiles[p]) {
                                    ...
                                    a:{
                                        ...
                                        var C = w;
                                        if (q.b) {
                                            var A = void 0, B = void 0, L = void 0, J = void 0;
                                            for (J in g)
                                                if (J in q.b)
            ...
            for (I in d)
                e = document.createElement("LI"), e.innerHTML = d[I].a, this.J.appendChild(e),
    ...
    function Sg(a) {
        a = a ? a : {};
        var c = void 0 !== a.className ? a.className : "ol-zoom", d = void 0 !== a.delta ? a.delta : 1, e = void 0 !== a.zoomOutLabel ? a.zoomOutLabel : "\u2212", f = void 0 !== a.zoomOutTipLabel ? a.zoomOutTipLabel : "Zoom out", g = Ef("BUTTON", {"class": c + "-in", type: "button", title: void 0 !== a.zoomInTipLabel ? a.zoomInTipLabel : "Zoom in"}, void 0 !== a.zoomInLabel ? a.zoomInLabel : "+");
    ...
    Yg.prototype.A = function () {
        var a = this.f + "-true", c = this.f + "-false", d = Lf(this.element), e = this.a;
    ...
    var oh = function () {
        ...
        return function () {
            if (void 0 === a)
                if (aa.getComputedStyle) {
                    var c =
                            document.createElement("P"), d, e = {webkitTransform: "-webkit-transform", OTransform: "-o-transform", msTransform: "-ms-transform", MozTransform: "-moz-transform", transform: "transform"};
                    document.body.appendChild(c);
                    for (var f in e)
    ...
    ;
    var uh, vh = "undefined" !== typeof navigator ? navigator.userAgent.toLowerCase() : "", wh = -1 !== vh.indexOf("firefox"), xh = -1 !== vh.indexOf("safari") && -1 === vh.indexOf("chrom"), yh = -1 !== vh.indexOf("macintosh"), zh = aa.devicePixelRatio || 1, Ah = !1, Bh = function () {
    ...
    }(), Ch = "DeviceOrientationEvent"in aa, Dh = "geolocation"in aa.navigator, Eh = "ontouchstart"in aa, Fh = "PointerEvent"in aa, Gh = !!aa.navigator.msPointerEnabled,
            Hh = !1, Ih, Jh = [];
    ...
    ;
    function Mh(a) {
        Lh.call(this, a, {mousedown: this.Vk, mousemove: this.Wk, mouseup: this.Zk, mouseover: this.Yk, mouseout: this.Xk});
        this.a = a.g;
        this.g = []
    }
    y(Mh, Lh);
    ...
    function Oh(a) {
        var c = Ph(a, a), d = c.preventDefault;
    ...
    function Xh(a) {
        Lh.call(this, a, {MSPointerDown: this.dl, MSPointerMove: this.el, MSPointerUp: this.hl, MSPointerOut: this.fl, MSPointerOver: this.gl, MSPointerCancel: this.cl, MSGotPointerCapture: this.al, MSLostPointerCapture: this.bl});
        this.a = a.g;
    ...
    function Zh(a) {
        Lh.call(this, a, {pointerdown: this.Bn, pointermove: this.Cn, pointerup: this.Fn, pointerout: this.Dn, pointerover: this.En, pointercancel: this.An, gotpointercapture: this.jk, lostpointercapture: this.Uk})
    }
    y(Zh, Lh);
    l = Zh.prototype;
    l.Bn = function (a) {
    ...
    function ai(a, c) {
        Lh.call(this, a, {touchstart: this.Io, touchmove: this.Ho, touchend: this.Go, touchcancel: this.Fo});
        this.a = a.g;
        this.j = c;
        this.g = void 0;
        this.i = 0;
    ...
    l.wn = function (a, c) {
        this.a[c.pointerId] = {target: c.target, zc: c, uh: c.target};
        var d = this.b;
        c.bubbles = !0;
        Qh(d, ei, c, a);
        d = this.b;
    ...
    function Ph(a, c) {
        for (var d = {}, e, f = 0, g = li.length; f < g; f++)
    ...
    var ti = "singleclick", ri = "click", si = "dblclick", zi = "pointerdrag", yi = "pointermove", xi = "pointerdown", vi = "pointerup", wi = "pointercancel", Ai = {ap: ti, Qo: ri, Ro: si, Uo: zi, Xo: yi, To: xi, $o: vi, Zo: "pointerover", Yo: "pointerout", Vo: "pointerenter", Wo: "pointerleave", So: wi};
    function Bi(a) {
        Mb.call(this);
        var c = mb({}, a);
    ...
    y(Bi, Mb);
    function Ci(a) {
        var c = a.Sb(), d = a.df(), e = a.wb(), f = a.G(), g = a.Tb(), h = a.Nb(), k = a.Ob();
    ...
    function Wi(a) {
        ...
        var g = void 0 !== a.src ? 0 : 2, h = void 0 !== a.color ? Xe(a.color) : null, k = Xi.Zb(), m = k.get(f,
                c, h);
    ...
    function ij(a) {
        var c = a.o, d = a.b, e = a.a, f = 0, g = d.length, h, k, m;
        for (k = 0; k < g; ++k)
    ...
    function kj(a, c, d) {
        for (var e = 0, f; a.c < c && e < d && 0 < a.rc(); )
    ...
    function sj(a) {
        ...
        if (a.type == si) {
            var c = a.map, e = a.coordinate, d = d.shiftKey ? -this.a : this.a, f = c.$();
            pj(c, f, d, e, this.c);
            a.preventDefault();
            c = !0
        }
    ...
    Bj.prototype.Dc = hd;
    function Ej(a) {
        Bj.call(this, {handleDownEvent: Fj, handleDragEvent: Gj, handleUpEvent: Hj});
        a = a ? a : {};
        this.a = a.kinetic;
        this.c = this.o = null;
    ...
    function Gj(a) {
        ...
        if (this.c) {
            ...
            a = a.map;
            var f = a.$(), g = f.V(), e = d = [d, e], h = g.resolution;
            e[0] *= h;
            e[1] *= h;
            gc(d, g.rotation);
            bc(d, g.center);
    ...
    function Lj(a) {
        ...
        var c = a.$();
        Be(c, -1);
        var d = c.Ka(), e = this.o, d = c.constrainRotation(d, 0);
        oj(a, c, d, void 0, e);
        return!1
    }
    function Jj(a) {
    ...
    function Oj(a) {
        var c = a.c, d = a.g, c = [c, [c[0], d[1]], d, [d[0], c[1]]].map(a.b.La, a.b);
        c[4] = c[0].slice();
    ...
    y(Pj, Eb);
    function Qj(a) {
        Bj.call(this, {handleDownEvent: Rj, handleDragEvent: Sj, handleUpEvent: Tj});
        a = a ? a : {};
    ...
    Vj.prototype.s = function () {
        var a = this.A, c = a.$(), d = a.Va(), e = this.X().G(), d = c.constrainResolution(Math.max(Wc(e) / d[0], Xc(e) / d[1])), f = c.Z(), g = c.Wa();
    ...
    function Xj(a) {
        ...
        if ("keydown" == a.type) {
            ...
            if (this.a(a) && (40 == d || 37 == d || 39 == d || 38 == d)) {
                var e = a.map, c = e.$(), f = c.Z() * this.l, g = 0, h = 0;
                40 == d ? h = -f : 37 == d ? g = -f : 39 == d ? g = f : h = f;
                d = [g, h];
                gc(d, c.Ka());
                f = this.c;
                if (g = c.Wa())
                    f && 0 < f && e.Ra(He({source: g, duration: f, easing: Fe})), e = c.Qd([g[0] + d[0], g[1] + d[1]]), c.mb(e);
                a.preventDefault();
                c = !0
            }
        }
    ...
    function ck(a) {
        Bj.call(this, {handleDownEvent: dk, handleDragEvent: ek, handleUpEvent: fk});
        a = a || {};
        this.c = null;
        this.o = void 0;
        this.a = !1;
    ...
    ck.prototype.Dc = ed;
    function gk(a) {
        Bj.call(this, {handleDownEvent: hk, handleDragEvent: ik, handleUpEvent: jk});
        a = a ? a : {};
        this.c = null;
    ...
    y(gk, Bj);
    function ik(a) {
        var c = 1, d = this.l[0], e = this.l[1], f = d.clientX - e.clientX, d = d.clientY - e.clientY, f = Math.sqrt(f * f + d * d);
        void 0 !== this.a && (c = this.a / f);
        this.a = f;
        1 != c && (this.o = c);
        a = a.map;
        var f = a.$(), d = f.Z(), e = Zf(a.a), g = Dj(this.l);
        g[0] -= e.x;
        g[1] -= e.y;
        this.c = a.La(g);
        a.render();
    ...
    function jk(a) {
        if (2 > this.l.length) {
            ...
            var c = a.$();
            Be(c, -1);
            var d = c.Z(), e = this.c, f = this.s, d = c.constrainResolution(d, 0, this.o - 1);
            qj(a, c, d, e, f);
            return!1
        }
        return!0
    ...
    function kk(a) {
        a = a ? a : {};
        var c = new Se, d = new lj(-.005, .05, 100);
        ...
        if (void 0 !== a.keyboard ? a.keyboard : 1)
            c.push(new Wj), c.push(new Yj({delta: a.zoomDelta,
    ...
    function mk(a) {
        nd.call(this, {code: a, units: "m", extent: nk, global: !0, worldExtent: ok})
    }
    y(mk, nd);
    mk.prototype.getPointResolution = function (a, c) {
        return a / Na(c[1] / 6378137)
    };
    var pk = 6378137 * Math.PI, nk = [-pk, -pk, pk, pk], ok = [-180, -85, 180, 85], Ad = "EPSG:3857 EPSG:102100 EPSG:102113 EPSG:900913 urn:ogc:def:crs:EPSG:6.18:3:3857 urn:ogc:def:crs:EPSG::3857 http://www.opengis.net/gml/srs/epsg.xml#3857".split(" ").map(function (a) {
        return new mk(a)
    });
    function Bd(a, c, d) {
        var e = a.length;
    ...
    function Hk(a) {
        if (void 0 === a.j) {
            var c = "s" + (a.b ? Ze(a.b) : "-") + "," + (void 0 !== a.f ? a.f.toString() : "-") + "," + (a.g ? a.g.toString() : "-") + "," + (void 0 !== a.c ? a.c : "-") + "," + (void 0 !== a.i ? a.i.toString() : "-") + "," + (void 0 !== a.a ? a.a.toString() : "-"), d = new Dk;
            Fk(d, c);
    ...
    function Ik(a) {
        ...
        if (void 0 === c)
            this.b = document.createElement("CANVAS"), this.b.height = h, this.b.width = h, d = h = this.b.width, c = this.b.getContext("2d"), this.qh(f, c, 0, 0), this.f ?
            ...
            var g = this.a ? Hk(this.a) : "-", k = this.f ? Bk(this.f) : "-";
    ...
    function Sk(a, c, d) {
        if (a.i) {
            ...
            for (k = c.length; h < k; h += 2) {
                var m = c[h] - a.ta, n = c[h + 1] - a.ua;
                a.Fb && (m = Math.round(m), n = Math.round(n));
                if (0 !== g || 1 != a.j) {
                    var p = m + a.ta, q = n + a.ua;
    ...
    l.Jc = function (a) {
        ...
        if (ad(this.c, c)) {
            if (this.b) {
                Vk(this, this.b);
                var c = this.g, d = a.ga(), e = 0, f = a.Cb(), g = a.qa();
                c.beginPath();
                var h, k;
                h = 0;
    ...
    l.Kc = function (a) {
        if (ad(this.c, a.G())) {
            if (this.b || this.a) {
                this.a && Uk(this, this.a);
                this.b && Vk(this, this.b);
                var c = this.g, d = al(a), e = 0, f = a.c, g = a.qa(), h, k;
                h = 0;
                for (k = f.length; h < k; ++h) {
                    var m = f[h];
                    c.beginPath();
    ...
    l.hb = function (a, c) {
        ...
        if (c) {
            ...
            this.b = {lineCap: void 0 !== e ? e : "round", lineDash: f ? f : xk, lineJoin: void 0 !== g ? g : "round", lineWidth: this.J * (void 0 !== h ? h : 1), miterLimit: void 0 !== k ? k : 10, strokeStyle: Ze(d ? d : yk)}
        } else
            this.b = null
    };
    l.yb = function (a) {
        if (a) {
            var c = a.Yb(), d = a.gc(1), e = a.Ha(), f = a.Eb();
            this.ta = c[0];
            this.ua = c[1];
            this.S = f[1];
            this.i = d;
    ...
    l.ib = function (a) {
        if (a) {
            ...
            if (d) {
                ...
                this.s = {lineCap: void 0 !== e ? e : "round", lineDash: f ? f : xk, lineJoin: void 0 !== g ? g : "round", lineWidth: void 0 !== h ? h : 1, miterLimit: void 0 !== d ? d : 10, strokeStyle: Ze(c ? c : yk)}
            } else
                this.s = null;
            var c = a.g, e = a.f, f = a.c, g = a.i, h = a.a, d = a.Fa(), k = a.l;
            a = a.o;
    ...
    dl.prototype.c = function (a, c, d) {
        ...
        if (e) {
            ...
            if (g) {
                var h = a.pixelRatio, k = a.size[0] * h, m = a.size[1] * h, n = a.viewState.rotation, p = Sc(f), q = Rc(f), r = Qc(f), f = Pc(f);
    ...
    function ll(a, c, d, e, f, g, h, k, m) {
        ...
        e = !pb(g);
        var p = 0, q = h.length, r = 0, t, v = a.Ca;
        a = a.wa;
        for (var w, z, C, A; p < q; ) {
            var B = h[p], L, J, M, P;
            switch (B[0]) {
                ...
                case 4:
                    ...
                    for (B[10] && (C += f); r < t; r += 2) {
                        ...
                        var Ec = ab + ca > L.width ? L.width - ca : ab, Uc = I + Da > L.height ? L.height - Da : I;
                        c.drawImage(L, ca, Da, Ec, Uc, B, P, Ec * d, Uc * d);
                        1 != J && (c.globalAlpha = Pa);
                        if (1 != A || 0 !== C)
                            tc(v, a), c.transform(a[0],
    ...
    pl.prototype.Ib = function (a, c) {
        if (this.l) {
            kl(this, c);
            var d = a.ga(), e = this.coordinates.length, d = jl(this, d, 0, d.length, a.qa(), !1);
    ...
    pl.prototype.yb = function (a) {
        var c = a.Yb(), d = a.Eb(), e = a.pe(1), f = a.gc(1), g = a.Ha();
        this.g = c[0];
        this.i = c[1];
        this.S = e;
        this.l = f;
    ...
    l.Jc = function (a, c) {
        ...
        if (void 0 !== d.strokeStyle && void 0 !== e) {
            ...
            var d = a.Cb(), e = a.ga(), f = a.qa(), g = 0, h, k;
            h = 0;
            for (k = d.length; h < k; ++h)
                g = rl(this, e, g, d[h], f);
            this.b.push([12]);
    ...
    l.Kc = function (a, c) {
        ...
        if (void 0 !== d.fillStyle || void 0 !== e) {
            ...
            this.b.push([9, Ze(wk)]);
            void 0 !== d.strokeStyle && this.b.push([10, d.strokeStyle, d.lineWidth, d.lineCap, d.lineJoin, d.miterLimit, d.lineDash]);
            var d = a.c, e = al(a), f = a.qa(), g = 0, h, k;
            h = 0;
            for (k = d.length; h < k; ++h)
                g = ul(this, e, g, d[h], f);
            nl(this, c)
    ...
    wl.prototype.ib = function (a) {
        if (a) {
            ...
            var d = a.j;
            if (d) {
                var c = d.b, e = d.f, f = d.g, g = d.c, h = d.a, d = d.i, e = void 0 !== e ? e : "round", f = f ? f.slice() : xk, g = void 0 !== g ? g : "round", h = void 0 !== h ? h : 1, d = void 0 !== d ? d : 10, c = Ze(c ? c : yk);
                if (this.i) {
                    var k = this.i;
                    k.lineCap = e;
                    k.lineDash = f;
                ...
                this.i = null;
            var m = a.g, c = a.f, e = a.c, f = a.i, h = a.a, d = a.Fa(), g = a.l, k = a.o;
    ...
    var Fl = {Point: function (a, c, d, e) {
            ...
            if (f = d.Fa())
                a = a.b(d.b, "Text"), a.ib(f), d = bl(c), a.Jb(d, 0, d.length, 2,
                        c, e)
    ...
    function Kl(a, c, d, e, f, g, h, k, m, n, p) {
        ...
        var t = nh(Math.round(d * Wc(r) / e), Math.round(d * Xc(r) / e)), v = d / e;
        m.forEach(function (a) {
        ...
        k.f.forEach(function (a) {
            ...
            a = (f[0][0] -
            w[0]) / g;
            var p = -(f[0][1] - w[1]) / g, v = (f[1][0] - w[0]) / g, I = -(f[1][1] - w[1]) / g, ca = (f[2][0] - w[0]) / g, Da = -(f[2][1] - w[1]) / g, f = c[0][0], c = c[0][1], h = h - f, k = k - c, m = m - f, n = n - c;
            a:{
    ...
    function Ml(a, c, d, e, f, g, h, k, m, n) {
        var p = xc([g, h, k, m]), q = a.b ? Wc(p) / a.b : null, r = a.g.b && .5 < q && 1 > q, t = !1;
        if (0 < n) {
            if (a.c.g && a.j)
                var v = xc([c, d, e, f]), t = t | .25 < Wc(v) / a.j;
            !r && a.g.g && q && (t |= .25 < q)
        }
        if (t || !a.i || ad(p, a.i)) {
    ...
    function Ol(a, c, d, e, f, g) {
        this.A = c;
        this.s = a.G();
        var h = c.G(), k = h ? $c(d, h) : d, h = Il(a, c, Yc(k), e);
    ...
    function Pl(a) {
        rg.call(this, {attributions: a.attributions, extent: a.extent, logo: a.logo, projection: a.projection, state: a.state});
    ...
    (function () {
        ...
        (function () {
            ...
            c.prototype = {all: function () {
                    ...
                    this.data.children.length ? this.data.height === a.height ? this.$f(this.data, a) : (this.data.height < a.height && (c = this.data, this.data = a, a = c), this.Xf(a, this.data.height - a.height - 1,
                            !0)) : this.data = a;
                    return this
                }, za: function (a) {
                    ...
                    var g = e - c + 1, h = this.Qe, k;
                    if (g <= h)
                        return k = {children: a.slice(c, e + 1), height: 1, bbox: null, Ja: !0}, d(k, this.kb), k;
                    ...
                    var e = a[c], f = e.children.length, g = this.Yf;
                    this.Pi(e, g, f);
                    f = this.Qi(e, g, f);
                    ...
                    var e = a.Ja ? this.Te : g, f = a.Ja ? this.Ue : h, k = this.Uf(a, c, d, e);
                    c = this.Uf(a,
                            c, d, f);
    ...
    mn.prototype.l = function (a, c) {
        ...
        if (this.f) {
            var e = this.f, k = e.G(), m = e.Z(), n = e.f, g = d * m / (g * n);
    ...
    nn.prototype.c = function (a, c, d) {
        var e = a.pixelRatio, f = a.viewState, g = f.center, h = f.projection, k = a.size, f = e / f.resolution, m = this.a, n = m.da(), p = n.Ud(h), q = gl(this, a, 0);
        el(this, "precompose", d, a, q);
        Ib(m, "render") ? (this.i.canvas.width = d.canvas.width, this.i.canvas.height = d.canvas.height, m = this.i) : m = d;
        var r = Math.round(e * k[0] / 2), k = Math.round(e * k[1] / 2), t = m.globalAlpha;
        m.globalAlpha = c.opacity;
        var v = n.Za(h), w = this.j, z;
        c = n.cf(h) && 1 == c.opacity;
        c || (w.reverse(), z = []);
        for (var C = 0, A = w.length; C < A; ++C) {
            var B = w[C], L = B.ja, J =
                    v.Da(L, this.s), M = L[0], P = Pc(v.Da(v.ud(g, M))), L = Math.round(Wc(J) * f), Aa = Math.round(Xc(J) * f), I = Math.round((J[0] - P[0]) * f / L) * L + r + Math.round((P[0] - g[0]) * f), J = Math.round((P[1] - J[3]) * f / Aa) * Aa + k + Math.round((g[1] - P[1]) * f);
            if (!c) {
                P = [I, J, I + L, J + Aa];
                m.save();
    ...
    nn.prototype.l = function (a, c) {
        ...
        var e = a.pixelRatio, f = a.viewState, g = f.projection, h = this.a, k = h.da(), m = k.Za(g), n = Dg(m, f.resolution), p = m.Z(n), q = f.center;
        ...
        q = {};
        q[n] = {};
        var r = this.cd(k, g, q), t = h.f(), v = yc(), w = new Me(0, 0, 0, 0), z, C, A, B;
        for (A = p.ra; A <= p.va; ++A)
            for (B = p.xa; B <= p.Aa; ++B)
                z = k.Qb(n, A, B, e, g), !d(z) && z.a && (z = z.a), d(z) ?
    ...
    on.prototype.c = function (a, c, d) {
        var e = a.extent, f = a.pixelRatio, g = c.Pc ? a.skippedFeatureUids : {}, h = a.viewState, k = h.projection, h = h.rotation, m = k.G(), n = this.a.da(), p = gl(this, a, 0);
        ...
        if (q && !q.Oa()) {
            ...
            q.a(r, f, p, h, g);
            if (n.J && k.b && !Gc(m, e)) {
                for (var k = e[0], n = Wc(m), w = 0; k < m[0]; )
                    --w,
    ...
    on.prototype.l = function (a) {
        ...
        if (!this.j && !h && f || !k && g)
            return!0;
        var m = a.extent, k = a.viewState, f = k.projection, n = k.resolution, p = a.pixelRatio, g = d.g, q = d.a, h = Qk(d);
        void 0 ===
                h && (h = Cl);
        m = Ac(m, q * n);
        q = k.projection.G();
    ...
    ;
    function un(a) {
        Ig.call(this, {attributions: a.attributions, Re: a.Re, extent: a.extent, logo: a.logo, opaque: a.opaque, projection: a.projection, state: a.state, tileGrid: a.tileGrid, tilePixelRatio: a.tilePixelRatio, wrapX: a.wrapX});
    ...
    xn.prototype.c = function (a, c, d) {
        var e = a.pixelRatio, f = c.Pc ? a.skippedFeatureUids : {}, g = a.viewState, h = g.center, k = g.projection, m = g.resolution, g = g.rotation, n = a.size, p = e / m, q = this.a, r = q.da(), t = r.uc(e), v = gl(this, a, 0);
        ...
        c = this.A;
        var z = r.tileGrid, C, A, B, L, J, M, P, Aa, I, ca, Da, Ia, ab;
        B = 0;
        for (L = c.length; B < L; ++B)
            if (ca = c[B], J = ca.c, Aa = z.Da(ca.ja, this.T),
                    C = ca.ja[0], Ia = Sb(z.Ua(C), this.J), I = "tile-pixels" == ca.g.a, M = z.Z(C), Da = M / t, A = M / m, M = Math.round(e * n[0] / 2), P = Math.round(e * n[1] / 2), ab = Ia[0] * e * A, A *= Ia[1] * e, Ia = Ia[0] * e, ab < Ia / 4 || ab > 4 * Ia)
                ...
                if (J.resolution !== m || J.rotation !== g)
                    J.resolution = m, J.rotation = g, ca.canvas.width = ab + .5, ca.canvas.height =
    ...
    function yn(a, c, d, e, f) {
        ...
        var h = d.g, k = Qk(d) || null, m = c.c;
        if (m.kd || m.Kh != h || m.Kf != k) {
            Db(m.Vc);
            m.Vc = null;
            m.kd = !1;
            var n = d.da(), p = n.tileGrid, q = c.ja, r = c.g, t = "tile-pixels" == r.a, v, w;
            t ? (v = Kg(n, q[0], e, c.g), v = [0, 0, v[0], v[1]]) : (v = p.Da(q), Hd(f, r) || (w = !0,
                    c.g = f));
            var z = p.Z(q[0]), n = t ? n.uc(e) : z;
            m.kd = !1;
            var C = new xl(0, v, n, d.a), A = Dl(n, e);
            c = c.i;
            k && k !== m.Kf && c.sort(k);
            n = 0;
    ...
    xn.prototype.gb = function (a, c, d, e) {
        ...
        var h = this.a, k = {}, m = this.A, n = h.da(), p = n.tileGrid, q, r, t, v, w, z;
        t = 0;
    ...
    xn.prototype.l = function (a, c) {
        ...
        if (Vc(h))
            return!1;
        for (var g = a.viewState, f = g.projection, k = g.resolution, g = a.pixelRatio, m = e.tileGrid, n = m.Pb(), p = n.length - 1; 0 < p && n[p] < k; )
            --p;
        n = yg(m, h, p);
        ...
        h = {};
        h[p] = {};
        var q = this.cd(e, f, h), r = d.S(), t = this.T, v = new Me(0, 0, 0, 0), w, z, C;
        for (z = n.ra; z <=
                n.va; ++z)
            for (C = n.xa; C <= n.Aa; ++C)
    ...
    zn.prototype.Ce = function (a) {
        if (a) {
            var c, d = a.pixelRatio, e = a.size[0] * d, f = a.size[1] * d;
            this.b.width = e;
            this.b.height = f;
            var g = a.viewState.rotation, h;
            if (g) {
                c = this.j;
            ...
            cb(d);
            var k = a.viewState.resolution, m, n, p, q;
            m = 0;
            for (n = d.length; m < n; ++m)
                q = d[m], p = q.layer, p = cj(this, p), Gi(q, k) && "ready" == q.H && p.l(a, q) &&
                        p.c(a, q, c);
    ...
    Dn.prototype.j = function (a, c) {
        ...
        var d = a.pixelRatio, e = a.viewState, f = e.projection, g = this.a, h = g.da(), k = h.Za(f), m = h.Ud(f), n = Dg(k, e.resolution), p = k.Z(n), q = e.center, r;
        p == e.resolution ? (q = Ti(q, p, a.size), r = Zc(q, p, e.rotation, a.size)) : r = a.extent;
        void 0 !== c.extent && (r = $c(r, c.extent));
        var p = Ag(k, r, p), t = {};
        t[n] = {};
        var v = this.cd(h, f, t), w = g.f(), z = yc(), C = new Me(0, 0, 0, 0), A, B, L, J;
        for (L = p.ra; L <= p.va; ++L)
            for (J = p.xa; J <= p.Aa; ++J)
                A = h.Qb(n, L, J, d, f), B = A.V(), B = 2 ==
        ...
        for (J = z.length; L < J; ++L) {
            ...
            for (P in M) {
                A = w;
                B = M[P];
                var Aa = m, I = B.ja, ca = I[0], Da = I[1], Ia = I[2], I = I.toString();
                if (!(I in A.a)) {
                    var ca = Sb(A.c.Ua(ca),
                            A.l), ab = B.cb(A), Pa = ab.style;
                    Pa.maxWidth = "none";
                    var Ec = void 0, Uc = void 0;
    ...
    Fn.prototype.o = function (a, c) {
        var d = a.viewState, e = d.center, f = d.rotation, g = d.resolution, d = a.pixelRatio, h = a.size[0], k = a.size[1], m = h * d, n = k * d, e = Ji(this.H, d * h / 2, d * k / 2, d / g, -d / g, -f, -e[0], -e[1]), g = this.l;
        g.canvas.width = m;
        g.canvas.height = n;
    ...
    function Sn(a, c) {
        var d = a.a, e = String(x(c)), f = a.g[e];
    ...
    function Tn(a) {
        if (!a.j) {
            var c = a.a, d = c.createFramebuffer();
            c.bindFramebuffer(c.FRAMEBUFFER, d);
            var e = Un(c, 1, 1), f = c.createRenderbuffer();
    ...
    function Vn(a, c) {
        ...
        if (d in a.i)
            return a.i[d];
        var e = a.a, f = e.createShader(c.W());
    ...
    y(Zn, Di);
    function $n(a, c) {
        var d = a.A, e = a.l, f = a.oa, g = a.j, h = c.a;
        return function () {
            if (!h.isContextLost()) {
                var a, m;
                a = 0;
    ...
    function ao(a, c, d, e) {
        var f = a.B, g = a.J, h = a.H, k = a.ta, m = a.ua, n = a.S, p = a.Ga, q = a.U, r = a.aa ? 1 : 0, t = a.Ca, v = a.wa, w = a.na, z = Math.cos(t), t = Math.sin(t), C = a.a.length, A = a.b.length, B, L, J, M, P, Aa;
        for (B = 0; B < d; B += e)
            P = c[B] - a.o[0], Aa = c[B + 1] - a.o[1], L = A / 8, J = -v * f, M = -v * (h - g), a.b[A++] = P, a.b[A++] = Aa, a.b[A++] = J * z - M * t, a.b[A++] = J * t + M * z, a.b[A++] = p / m, a.b[A++] = (q + h) / k, a.b[A++] = n, a.b[A++] = r, J = v * (w - f), M = -v * (h - g), a.b[A++] = P, a.b[A++] = Aa, a.b[A++] = J * z - M * t, a.b[A++] = J * t + M * z, a.b[A++] = (p + w) / m, a.b[A++] = (q + h) / k, a.b[A++] = n, a.b[A++] = r, J = v * (w - f), M =
    ...
    function eo(a, c, d, e, f, g, h, k, m, n, p) {
        ...
        Rn(c, 34962, a.A);
        Rn(c, 34963, a.l);
        var r = Mn.Zb(), t = Nn.Zb(), t = Wn(c, r, t);
    ...
    Zn.prototype.yb = function (a) {
        var c = a.Yb(), d = a.gc(1), e = a.qd(), f = a.pe(1), g = a.A, h = a.Ha(), k = a.B, m = a.s, n = a.Eb();
        a = a.j;
        var p;
    ...
    l.Ib = function (a, c) {
        var d = this.a, e = (new go(1, this.f)).b(0, "Image");
        e.yb(this.g);
        e.Ib(a, c);
        bo(e, d);
    ...
    so.prototype.ih = function (a, c, d) {
        ...
        Rn(d, 34962, this.S);
        var e = d.a, f = po.Zb(), g = qo.Zb(), f = Wn(d, f, g);
    ...
    vo.prototype.sf = function (a, c) {
        var d = this.f.f, e = a.pixelRatio, f = a.viewState, g = f.center, h = f.resolution, k = f.rotation, m = this.c, n = this.pb, p = this.a.da(), q = a.viewHints, r = a.extent;
        void 0 !== c.extent && (r = $c(r, c.extent));
    ...
    vo.prototype.yc = function (a, c, d, e) {
        if (this.c && this.c.a())
            if (this.a.da()instanceof kn) {
                ...
                Li(this.o, a, c);
                if (!(0 > c[0] || c[0] > f[0] || 0 >
                c[1] || c[1] > f[1]) && (this.l || (this.l = nh(1, 1)), this.l.clearRect(0, 0, 1, 1), this.l.drawImage(this.c.a(), c[0], c[1], 1, 1, 0, 0, 1, 1), 0 < this.l.getImageData(0, 0, 1, 1).data[3]))
                    return d.call(e, this.a)
            }
    };
    function yo() {
    ...
    l.sf = function (a, c, d) {
        var e = this.f, f = d.a, g = a.viewState, h = g.projection, k = this.a, m = k.da(), n = m.Za(h), p = Dg(n, g.resolution), q = n.Z(p), r = Kg(m, p, a.pixelRatio, h), t = r[0] / Sb(n.Ua(p), this.H)[0], v = q / t, w = m.Ud(h), z = g.center, C;
        q == g.resolution ? (z = Ti(z, q, a.size), C = Zc(z, q, g.rotation, a.size)) : C = a.extent;
        q = Ag(n, C, q);
        if (this.l && Oe(this.l, q) && this.o == m.g)
            v = this.B;
        else {
            var A = [q.va - q.ra + 1, q.Aa - q.xa + 1], B = Math.pow(2, Math.ceil(Math.log(Math.max(A[0] * r[0], A[1] * r[1])) / Math.LN2)), A = v * B, L = n.Ha(p), J = L[0] + q.ra * r[0] * v, v = L[1] + q.xa * r[1] *
                    v, v = [J, v, J + A, v + A];
            to(this, a, B);
            f.viewport(0, 0, B, B);
            ...
            d = {};
            d[p] = {};
            var M = this.cd(m, h, d), P = k.f(), B = !0, J = yc(), Aa = new Me(0, 0, 0, 0), I, ca, Da;
            ...
            for (var M = new Float32Array(4), Ia, ab, Pa, P = 0, Aa = c.length; P < Aa; ++P)
                for (Ia in ab = d[c[P]], ab)
                    L = ab[Ia], I = n.Da(L.ja, J), ca = 2 * (I[2] - I[0]) / A, Da = 2 * (I[3] - I[1]) / A, Pa = 2 * (I[0] - v[0]) / A - 1,
    ...
    l.sf = function (a, c, d) {
        ...
        if (!this.o && !k && g || !m && h)
            return!0;
        var h = a.extent, k = a.viewState, g = k.projection, n = k.resolution, p = a.pixelRatio, k = f.g, q = f.a, m = Qk(f);
        void 0 === m &&
                (m = Cl);
        h = Ac(h, q * n);
    ...
    l.lo = function (a) {
        var c, d, e, f = this.Va(), g = this.$(), h = null;
        if (void 0 !== f && 0 < f[0] && 0 < f[1] && g && Ae(g)) {
            var h = g.f.slice(), k = this.sc().bf(), m = {};
            c = 0;
            for (d = k.length; c < d; ++c)
                m[x(k[c].layer)] = k[c];
            e = g.V();
            h = {animate: !1, attributions: {}, coordinateToPixelMatrix: this.qb, extent: null, focus: this.U ? this.U : e.center, index: this.Fb++, layerStates: m, layerStatesArray: k, logos: mb({}, this.Ec), pixelRatio: this.$c, pixelToCoordinateMatrix: this.Me, postRenderFunctions: [], size: f, skippedFeatureUids: this.aa, tileQueue: this.na, time: a,
    ...
    l.Xc = function () {
        var a = this.tc();
        if (a) {
            var c = Af(a), d = kf && a.currentStyle;
    ...
    l.Ek = function () {
        ...
        if (void 0 !== this.get("position") && this.autoPan) {
            var a = this.ie();
            if (void 0 !== a && a.tc()) {
                var c = Lo(a.tc(), a.Va()), d = this.he(), e = d.offsetWidth, f = d.currentStyle || window.getComputedStyle(d), e = e + (parseInt(f.marginLeft, 10) + parseInt(f.marginRight, 10)), f = d.offsetHeight, g = d.currentStyle || window.getComputedStyle(d), f = f + (parseInt(g.marginTop, 10) + parseInt(g.marginBottom, 10)), h = Lo(d, [e, f]), d = this.j;
    ...
    function Lo(a, c) {
        var d = Af(a), e = new wf(0, 0), f;
        f = d ? Af(d) : document;
        f = !kf || 9 <= uf || Nf(yf(f)) ? f.documentElement : f.body;
        if (a != f) {
            f = Yf(a);
            var g = yf(d).b, d = g.scrollingElement ? g.scrollingElement : nf ? g.body || g.documentElement : g.documentElement, g = g.parentWindow || g.defaultView, d = kf && sf("10") && g.pageYOffset != d.scrollTop ? new wf(d.scrollLeft, d.scrollTop) : new wf(g.pageXOffset || d.scrollLeft, g.pageYOffset || d.scrollTop);
            e.x = f.left + d.x;
            e.y = f.top + d.y
        }
    ...
    function Ko(a) {
        ...
        if (void 0 !== c && c.f && void 0 !== d) {
            var d = c.Ta(d), e = c.Va(), c = a.f.style, f = a.Ag(), g = a.Bg(), h = f[0], f = f[1];
    ...
    function Oo() {
        ...
        if (a.f && c.f) {
            var d = a.Va(), a = a.$().bd(d), e = c.Va(), d = c.$().bd(e), f = c.Ta(Sc(a)), c = c.Ta(Qc(a)), c = new xf(Math.abs(f[0] - c[0]), Math.abs(f[1] - c[1])), f = e[0], e = e[1];
    ...
    function Qo(a) {
        ...
        if (c.f && d.f) {
            var e = c.Va(), f = c.$(), g = d.$();
            d.Va();
            var c = f.Ka(), h = a.o, d = a.o.he(), f = f.bd(e), e = g.Z(), g = Pc(f), f = Rc(f), k;
            if (a = a.a.$().Wa())
    ...
    function Vo(a) {
        var c = a.A;
        if (c) {
            var d = c.projection, e = d.$b(), c = d.getPointResolution(c.resolution, c.center) * e, e = a.o * c, d = "", f = a.J();
            ...
            for (var f =
                    3 * Math.floor(Math.log(a.o * c) / Math.log(10)), g; ; ) {
    ...
    function Wo(a) {
        ...
        var c = void 0 !== a.className ? a.className : "ol-zoomslider", d = Ef("BUTTON", {type: "button", "class": c + "-thumb ol-unselectable"}), c = Ef("DIV", [c, "ol-unselectable", "ol-control"], d), e = new hi(c);
        Cb(this, qa(Db, e));
        D(e, Sh, this.lk, this);
        D(e, Th, this.Dg, this);
        D(e, Uh, this.Eg, this);
    ...
    function Yo(a) {
        if (a.frameState) {
            if (!this.U) {
                var c = this.element, d = $f(c), e = Lf(c), c = eg(e, "margin"), f = new xf(e.offsetWidth, e.offsetHeight), e = f.width + c.right + c.left, c = f.height + c.top + c.bottom;
                this.D = [e, c];
                e = d.width - e;
                c = d.height - c;
    ...
    function bp(a) {
        ...
        var c = void 0 !== a.className ? a.className : "ol-zoom-extent", d = Ef("BUTTON", {type: "button", title: void 0 !== a.tipLabel ? a.tipLabel : "Fit to extent"}, void 0 !== a.label ? a.label : "E");
    ...
    bp.prototype.j = function (a) {
        ...
        var c = this.a;
        a = c.$();
        var d = this.f ? this.f : a.i.G(), c = c.Va();
        a.Xe(d, c)
    };
    function cp(a) {
        Mb.call(this);
    ...
    ;
    var hp = aa.JSON.parse, ip = aa.JSON.stringify;
    function jp() {
        this.defaultDataProjection = null
    }
    y(jp, dp);
    ...
    l.rd = function () {
        var a = this.v, c = this.c, d = this.f, e = [], f = 0, g, h;
        g = 0;
        for (h = c.length; g < h; ++g) {
    ...
    function $k(a) {
        var c = [], d = a.v, e = 0, f = a.c;
        a = a.a;
        var g, h;
        g = 0;
        for (h = f.length; g < h; ++g) {
            var k = f[g], e = lp(d, e, k, a, .5);
            Ya(c, e);
            e = k
        }
        return c
    ...
    l.Mc = function (a) {
        var c = [], d = [], e = this.v, f = this.c, g = this.a, h = 0, k = 0, m, n;
        m = 0;
        for (n = f.length; m < n; ++m) {
            var p = f[m], k = de(e, h, p, g, a, c, k);
            d.push(k);
            h = p
        }
        c.length = k;
    ...
    l.Ia = function (a) {
        a:{
            var c = this.v, d = this.c, e = this.a, f = 0, g, h;
            g = 0;
            for (h = d.length; g < h; ++g) {
                if (me(c, f, d[g], e, a)) {
                    a = !0;
    ...
    l.clone = function () {
        for (var a = new V(null), c = this.c.length, d = Array(c), e = 0; e < c; ++e)
            d[e] = this.c[e].slice();
    ...
    l.sb = function (a, c, d, e) {
        if (e < Cc(this.G(), a, c))
            return e;
        if (this.H != this.g) {
            var f = this.c, g = 0, h = 0, k, m;
            k = 0;
            for (m = f.length; k < m; ++k)
                var n = f[k], h = Wd(this.v, g, n, this.a, h), g = n[n.length - 1];
            this.S = Math.sqrt(h);
            this.H = this.g
        }
        f = al(this);
    ...
    l.Ql = function () {
        var a = al(this), c = this.c, d = 0, e = 0, f, g;
        f = 0;
        for (g = c.length; f < g; ++f)
            var h = c[f], e = e + Td(a, d, h, this.a), d = h[h.length - 1];
        return e
    };
    l.Y = function (a) {
        var c;
    ...
    function bl(a) {
        if (a.J != a.g) {
            var c = a.v, d = a.c, e = a.a, f = 0, g = [], h, k, m = yc();
            h = 0;
            for (k = d.length; h < k; ++h) {
                var n = d[h], m = Kc(c, f, n[0], e);
    ...
    l.Mc = function (a) {
        var c = [], d = [], e = this.v, f = this.c, g = this.a;
        a = Math.sqrt(a);
        var h = 0, k = 0, m, n;
        m = 0;
        for (n = f.length; m < n; ++m) {
            var p = f[m], q = [], k = ee(e, h, p, g, a, c, k, q);
            d.push(q);
            h = p[p.length - 1]
        }
        c.length = k;
    ...
    l.Wd = function () {
        var a = this.f, c = this.v, d = this.c, e = [], f = 0, g, h, k, m;
        g = 0;
        for (h = d.length; g < h; ++g) {
    ...
    l.Ia = function (a) {
        a:{
            var c = al(this), d = this.c, e = this.a, f = 0, g, h;
            g = 0;
            for (h = d.length; g < h; ++g) {
                var k = d[g];
                if (ne(c, f, k, e, a)) {
    ...
    l.la = function (a, c) {
        if (a) {
            Rd(this, c, a, 3);
            this.v || (this.v = []);
            var d = this.v, e = this.a, f = this.c, g = 0, f = f ? f : [], h = 0, k, m;
            k = 0;
    ...
    l = sp.prototype;
    l.Tc = function (a, c) {
        var d = tp(a.geometry, c), e = new Xl;
        this.b && e.Bc(this.b);
        e.Pa(d);
    ...
    l = Dp.prototype;
    l.Tc = function (a, c) {
        var d = Ep(a.geometry, c), e = new Xl;
        this.b && e.Bc(this.b);
        e.Pa(d);
    ...
    l.zf = function (a, c) {
        var d, e = a.getAttribute("fid") || wm(a, "http://www.opengis.net/gml", "id"), f = {}, g;
    ...
    l = Yp.prototype;
    l.zh = function (a, c) {
        var d = im(a, !1).replace(/^\s*|\s*$/g, ""), e = c[0].srsName, f = a.parentNode.getAttribute("srsDimension"), g = "enu";
        e && (e = qd(e)) && (g = e.f);
        d = d.split(/[\s,]+/);
        e = 2;
    ...
    l.Qn = function (a, c) {
        for (var d = im(a, !1), e = /^\s*([+\-]?\d*\.?\d+(?:[eE][+\-]?\d+)?)\s*/, f = [], g; g = e.exec(d); )
    ...
    l.Ke = function (a, c, d) {
        ...
        "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (c = c.Vd(), Nm({node: a, srsName: e}, bq, this.Ii, c, d, void 0, this)) : "Surface" === a.nodeName && (e = hm(a.namespaceURI, "patches"), a.appendChild(e), a = hm(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.Ke(a, c, d))
    };
    l.Fe = function (a, c, d) {
        var e = d[d.length - 1].srsName;
    ...
    Zp.prototype.o = function (a, c) {
        c = fp(this, c);
        var d = hm("http://www.opengis.net/gml", "geom"), e = {node: d, srsName: this.srsName, curve: this.c, surface: this.l, multiSurface: this.j, multiCurve: this.i};
        c && mb(e, c);
        this.Ie(d, a, [e]);
        return d
    };
    ...
    function nq(a, c) {
        var d = c[0], e = R({flatCoordinates: []}, oq, a, c);
        if (e) {
    ...
    function pq(a, c) {
        var d = c[0], e = R({flatCoordinates: [], ends: []}, qq, a, c);
        if (e) {
            var f = e.flatCoordinates;
            delete e.flatCoordinates;
            var g = e.ends;
    ...
    function rq(a, c) {
        var d = c[0], e = R({}, sq, a, c);
        if (e) {
            var f = jq([], a, e), f = new E(f, "XYZM");
            gp(f, !1, d);
            d = new Xl(f);
            d.C(e);
            return d
    ...
    var tq = {rte: nq, trk: pq, wpt: rq}, uq = Q(iq, {rte: Em(nq), trk: Em(pq), wpt: Em(rq)}), lq = Q(iq, {text: N(W, "linkText"), type: N(W, "linkType")}), oq = Q(iq, {name: N(W), cmt: N(W), desc: N(W), src: N(W), link: kq, number: N(Sp), extensions: mq, type: N(W), rtept: function (a, c) {
            var d = R({}, vq, a, c);
            d && jq(c[c.length - 1].flatCoordinates, a, d)
        }}), vq = Q(iq, {ele: N(Qp), time: N(Pp)}), qq = Q(iq, {name: N(W), cmt: N(W), desc: N(W), src: N(W), link: kq, number: N(Sp), type: N(W), extensions: mq, trkseg: function (a, c) {
            var d = c[c.length - 1];
            Mm(wq, a, c);
            ...
            wq = Q(iq, {trkpt: function (a, c) {
                    var d = R({}, xq, a, c);
                    d && jq(c[c.length - 1].flatCoordinates, a, d)
                }}), xq = Q(iq, {ele: N(Qp), time: N(Pp)}), sq = Q(iq, {ele: N(Qp), time: N(Pp), magvar: N(Qp), geoidheight: N(Qp), name: N(W), cmt: N(W), desc: N(W), src: N(W), link: kq, sym: N(W), type: N(W), fix: N(W), sat: N(Sp), hdop: N(Qp), vdop: N(Qp), pdop: N(Qp), ageofdgpsdata: N(Qp), dgpsid: N(Sp), extensions: mq});
    function yq(a, c) {
        c || (c = []);
    ...
    var Bq = ["text", "type"], Aq = Q(iq, {text: O(Vp), type: O(Vp)}), Fq = Q(iq, "name cmt desc src link number type rtept".split(" ")), Gq = Q(iq, {name: O(Vp), cmt: O(Vp), desc: O(Vp), src: O(Vp), link: O(zq), number: O(Xp), type: O(Vp), rtept: Hm(O(Cq))}), Hq = Q(iq, "name cmt desc src link number type trkseg".split(" ")), Kq = Q(iq, {name: O(Vp), cmt: O(Vp), desc: O(Vp), src: O(Vp), link: O(zq), number: O(Xp), type: O(Vp), trkseg: Hm(O(function (a, c, d) {
            Nm({node: a, geometryLayout: c.f, properties: {}}, Iq, Jq, c.Y(), d)
        }))}), Jq = Im("trkpt"), Iq = Q(iq, {trkpt: O(Cq)}),
            Dq = Q(iq, "ele time magvar geoidheight name cmt desc src link sym type fix sat hdop vdop pdop ageofdgpsdata dgpsid".split(" ")), Eq = Q(iq, {ele: O(Wp), time: O(function (a, c) {
        ...
        }), magvar: O(Wp), geoidheight: O(Wp), name: O(Vp), cmt: O(Vp), desc: O(Vp), src: O(Vp), link: O(zq), sym: O(Vp), type: O(Vp), fix: O(Vp), sat: O(Xp),
        hdop: O(Wp), vdop: O(Wp), pdop: O(Wp), ageofdgpsdata: O(Wp), dgpsid: O(Xp)}), Lq = {Point: "wpt", LineString: "rte", MultiLineString: "trk"};
    function Mq(a, c) {
        var d = a.X();
        if (d && (d = Lq[d.W()]))
    ...
    var Nq = Q(iq, {rte: O(function (a, c, d) {
            ...
            f.properties = c.P();
            if (c = c.X())
                c = gp(c, !0, e), f.geometryLayout = c.f, Cq(a, c.Y(),
                        d)
        })});
    ...
    y(Qq, Oq);
    var Rq = /^B(\d{2})(\d{2})(\d{2})(\d{2})(\d{5})([NS])(\d{3})(\d{5})([EW])([AV])(\d{5})(\d{5})/, Sq = /^H.([A-Z]{3}).*?:(.*)/, Tq = /^HFDTE(\d{2})(\d{2})(\d{2})/, Uq = /\r\n|\r|\n/;
    Qq.prototype.xd = function (a, c) {
        var d = this.b, e = a.split(Uq), f = {}, g = [], h = 2E3, k = 0, m = 1, n, p;
        n = 0;
    ...
    var vr = ["http://www.google.com/kml/ext/2.2"], wr = [null, "http://earth.google.com/kml/2.0", "http://earth.google.com/kml/2.1", "http://earth.google.com/kml/2.2", "http://www.opengis.net/kml/2.2"], xr = [255, 255, 255, 1], yr = new Ak({color: xr}), zr = [20, 2], Ar = [64, 64], Br = new Wi({anchor: zr, anchorOrigin: "bottom-left", anchorXUnits: "pixels", anchorYUnits: "pixels", crossOrigin: "anonymous", rotation: 0, scale: .5, size: Ar, src: "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png"}), Cr = new Gk({color: xr, width: 1}), Dr = new sr({font: "bold 16px Helvetica",
        fill: yr, stroke: new Gk({color: [51, 51, 51, 1], width: 2}), scale: .8}), ur = [new Kk({fill: yr, image: Br, text: Dr, stroke: Cr, zIndex: 0})], Er = {fraction: "fraction", pixels: "pixels"};
    function Fr(a, c) {
        var d = null, e = [0, 0], f = "start";
        a.a && (d = a.a.qd()) && 2 == d.length && (e[0] = a.a.j * d[0] / 2, e[1] = -a.a.j * d[1] / 2, f = "left");
        if (pb(a.Fa()))
            d = new sr({text: c, offsetX: e[0], offsetY: e[1], textAlign: f});
        else {
            var d = a.Fa(), g = {}, h;
            for (h in d)
                g[h] = d[h];
    ...
    function Qr(a, c) {
        var d = R({}, Rr, a, c), e = R(null, Sr, a, c);
        if (e) {
            var f = new T(null);
            f.ba("XYZ", e);
            f.C(d);
    ...
    function Yr(a, c) {
        var d = R({}, Rr, a, c), e = R([null], Zr, a, c);
        if (e && e[0]) {
    ...
    function $r(a, c) {
        ...
        if (!d)
            return null;
        var e = "fillStyle"in d ? d.fillStyle : yr, f = d.fill;
        void 0 === f || f || (e = null);
        var f = "imageStyle"in d ? d.imageStyle : Br, g = "textStyle"in d ? d.textStyle : Dr, h = "strokeStyle"in d ? d.strokeStyle : Cr, d = d.outline;
        void 0 === d || d || (h = null);
    ...
    var ds = Q(wr, {value: Fm(W)}), cs = Q(wr, {Data: function (a, c) {
            ...
            Mm(es, a, c)
        }}), Rr = Q(wr, {extrude: N(Np), altitudeMode: N(W)}), Nr = Q(wr, {coordinates: Fm(Jr)}), Zr = Q(wr, {innerBoundaryIs: function (a, c) {
            ...
            var d = c[c.length - 1].fi, e = im(a, !1);
            ...
            var d = c[c.length - 1].v, e = im(a, !1);
            (e = /^\s*([+\-]?\d+(?:\.\d*)?(?:e[+\-]?\d*)?)\s+([+\-]?\d+(?:\.\d*)?(?:e[+\-]?\d*)?)\s+([+\-]?\d+(?:\.\d*)?(?:e[+\-]?\d*)?)\s*$/i.exec(e)) ? d.push(parseFloat(e[1]),
                    parseFloat(e[2]), parseFloat(e[3]), 0) : d.push(0, 0, 0, 0)
        }})), Sr = Q(wr, {coordinates: Fm(Jr)}), hs = Q(wr, {href: N(Kr)}, Q(vr, {x: N(Qp), y: N(Qp), w: N(Qp), h: N(Qp)})), is = Q(wr, {Icon: N(function (a, c) {
            var d = R({}, hs, a, c);
            return d ? d : null
        }), heading: N(Qp), hotSpot: N(function (a) {
            var c = a.getAttribute("xunits"), d = a.getAttribute("yunits");
            return{x: parseFloat(a.getAttribute("x")), Qf: Er[c], y: parseFloat(a.getAttribute("y")), Rf: Er[d]}
        }), scale: N(Lr)}), fs = Q(wr, {LinearRing: Fm(Mr)}), js = Q(wr, {color: N(Ir), scale: N(Lr)}), ks = Q(wr, {color: N(Ir),
        width: N(Qp)}), Vr = Q(wr, {LineString: Em(Qr), LinearRing: Em(Tr), MultiGeometry: Em(Ur), Point: Em(Xr), Polygon: Em(Yr)}), ls = Q(vr, {Track: Em(Or)}), ns = Q(wr, {ExtendedData: bs, Link: function (a, c) {
            Mm(ms, a, c)
        }, address: N(W), description: N(W), name: N(W), open: N(Np), phoneNumber: N(W), visibility: N(Np)}), ms = Q(wr, {href: N(Kr)}), gs = Q(wr, {LinearRing: Fm(Mr)}), os = Q(wr, {Style: N($r), key: N(W), styleUrl: N(function (a) {
            var c = im(a, !1).trim();
            return a.baseURI ? nr(a.baseURI, c).toString() : c
        })}), qs = Q(wr, {ExtendedData: bs, MultiGeometry: N(Ur, "geometry"),
        LineString: N(Qr, "geometry"), LinearRing: N(Tr, "geometry"), Point: N(Xr, "geometry"), Polygon: N(Yr, "geometry"), Style: N($r), StyleMap: function (a, c) {
            var d = R(void 0, ps, a, c);
            if (d) {
                var e = c[c.length - 1];
                fa(d) ? e.Style = d : "string" === typeof d && (e.styleUrl = d)
            }
        }, address: N(W), description: N(W), name: N(W), open: N(Np), phoneNumber: N(W), styleUrl: N(Kr), visibility: N(Np)}, Q(vr, {MultiTrack: N(function (a, c) {
            var d = R([], ls, a, c);
            if (d) {
                var e = new U(null);
                op(e, d);
        ...
        }, "geometry"), Track: N(Or, "geometry")})), rs = Q(wr, {color: N(Ir), fill: N(Np),
        outline: N(Np)}), es = Q(wr, {SimpleData: function (a, c) {
            var d = a.getAttribute("name");
            if (null !== d) {
                var e = W(a);
                c[c.length - 1][d] = e
            }
        }}), as = Q(wr, {IconStyle: function (a, c) {
            var d = R({}, is, a, c);
            if (d) {
                ...
                n ? (h = [n.x, n.y], k = n.Qf, m = n.Rf) : "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png" === g ? (h = zr, m = k = "pixels") : /^http:\/\/maps\.(?:google|gstatic)\.com\//.test(g) && (h =
                        [.5, 0], m = k = "fraction");
                var p, n = f.x, q = f.y;
    ...
    function ws(a, c) {
        var d = Xe(c), d = [255 * (4 == d.length ? d[3] : 1), d[2], d[1], d[0]], e;
        for (e = 0; 4 > e; ++e) {
    ...
    var Ms = Q(wr, ["Document", "Placemark"]), Ps = Q(wr, {Document: O(function (a, c, d) {
        ...
        }), Placemark: O(As)}), Ns = Q(wr, {Placemark: O(As)}), Qs = {Point: "Point", LineString: "LineString", LinearRing: "LinearRing", Polygon: "Polygon", MultiPoint: "MultiGeometry", MultiLineString: "MultiGeometry", MultiPolygon: "MultiGeometry"}, Rs = Q(wr, ["href"], Q(vr, ["x", "y", "w", "h"])), Ss = Q(wr, {href: O(Vp)}, Q(vr, {x: O(Wp), y: O(Wp), w: O(Wp), h: O(Wp)})), Ts = Q(wr, ["scale", "heading", "Icon", "hotSpot"]), Vs = Q(wr, {Icon: O(function (a,
                c, d) {
            a = {node: a};
            var e = Rs[d[d.length - 1].node.namespaceURI], f = Lm(c, e);
            Nm(a, Ss, Km, f, d, e);
            e = Rs[vr[0]];
            f = Lm(c, e);
            Nm(a, Ss, Us, f, d, e)
        }), heading: O(Wp), hotSpot: O(function (a, c) {
            a.setAttribute("x", c.x);
            a.setAttribute("y", c.y);
            a.setAttribute("xunits", c.Qf);
            a.setAttribute("yunits", c.Rf)
        }), scale: O(Ls)}), Ws = Q(wr, ["color", "scale"]), Xs = Q(wr, {color: O(ws), scale: O(Ls)}), Ys = Q(wr, ["color", "width"]), Zs = Q(wr, {color: O(ws), width: O(Wp)}), ys = Q(wr, {LinearRing: O(Es)}), $s = Q(wr, {LineString: O(Es), Point: O(Es), Polygon: O(Hs)}), Bs = Q(wr,
            "name open visibility address phoneNumber description styleUrl Style".split(" ")), Cs = Q(wr, {MultiGeometry: O(function (a, c, d) {
            a = {node: a};
            var e = c.W(), f, g;
            "MultiPoint" == e ? (f = c.ke(), g = at) : "MultiLineString" == e ? (f = c.rd(), g = bt) : "MultiPolygon" == e && (f = c.Wd(), g = ct);
            Nm(a, $s, g, f, d)
        }), LineString: O(Es), LinearRing: O(Es), Point: O(Es), Polygon: O(Hs), Style: O(function (a, c, d) {
            a = {node: a};
            var e = {}, f = c.c, g = c.g, h = c.a;
            c = c.Fa();
            ...
            e = Lm(e, c);
            Nm(a, et, Km, e, d, c)
        }), address: O(Vp), description: O(Vp), name: O(Vp), open: O(Up), phoneNumber: O(Vp), styleUrl: O(Vp), visibility: O(Up)}), Fs = Q(wr, {coordinates: O(function (a, c, d) {
            d = d[d.length - 1];
            var e = d.layout;
            d = d.stride;
            var f;
            ...
            Vp(a, k)
        })}), Is = Q(wr, {outerBoundaryIs: O(xs), innerBoundaryIs: O(xs)}), ft = Q(wr, {color: O(ws)}),
            dt = Q(wr, ["IconStyle", "LabelStyle", "LineStyle", "PolyStyle"]), et = Q(wr, {IconStyle: O(function (a, c, d) {
            a = {node: a};
            var e = {}, f = c.Eb(), g = c.qd(), h = {href: c.b.o};
            if (f) {
                h.w = f[0];
                h.h = f[1];
                var k = c.Yb(), m = c.Ha();
    ...
    var gt = Im("color"), Gs = Im("coordinates"), Js = Im("innerBoundaryIs"), at = Im("Point"), bt = Im("LineString"), zs = Im("LinearRing"), ct = Im("Polygon"), Ks = Im("outerBoundaryIs");
    tr.prototype.a = function (a, c) {
        ...
        var g = Ms[d.namespaceURI], f = Lm(f, g);
            ...
            return function e(a, c, h) {
                ...
                return k
                        ...
                        (function (g) {
                            ...
                            var m = Math.pow(2,
                                    63);
                            h.prototype = {Cf: function (a, c, e) {
                                    for (e = e || this.length; this.ca < e; ) {
                                        var f = this.Ba(), g = this.ca;
                                        a(f >> 3, c, this);
                                        this.ca === g && this.Eo(f)
                                    }
                                    return c
                                    ...
                                    for (var f = c = 0; f < e - a + 1; f++)
                                        var g = ~this.Gb[a + f] & 127, c = c + (4 > f ? g << 7 * f : g * Math.pow(2, 7 * f));
                                    return-c - 1
                                }, Ad: function () {
                                    var a = this.Ba();
                                    ...
                                    var a = this.Ba() + this.ca, c = this.Gb.toString("utf8", this.ca, a);
                                    this.ca = a;
                                    return c
                                }, Eo: function (a) {
                                    a = a & 7;
                        ...
                        g.write = function (a, c, e, f, g, q) {
                            var r, t = 8 * q - g - 1, v = (1 << t) - 1, w = v >> 1, z = 23 === g ? Math.pow(2, -24) - Math.pow(2, -77) : 0;
                            q = f ? 0 : q - 1;
                            var C = f ? 1 : -1, A = 0 > c || 0 === c && 0 > 1 / c ? 1 : 0;
                            c = Math.abs(c);
        ...
        (function (d) {
            ...
            return function e(a, c, h) {
                ...
                return k
                    ...
                    }, {"./lib/vectortile.js": 2, "./lib/vectortilefeature.js": 3, "./lib/vectortilelayer.js": 4}], 2: [function (a, c) {
                        function g(a, c, e) {
                    ...
                    }, {"./vectortilelayer": 4}], 3: [function (a, c) {
                        ...
                        g.prototype.bbox = function () {
                            ...
                            for (var c = a.Ba() + a.ca, e = 1, f = 0, g = 0, h = 0, k = Infinity, w = -Infinity, z = Infinity, C = -Infinity; a.ca < c; )
                                if (f || (f = a.Ba(), e = f & 7, f = f >> 3), f--, 1 === e || 2 === e)
                                    g += a.Ad(), h += a.Ad(), g < k && (k = g), g > w && (w = g), h < z && (z = h), h > C &&
                                            (C = h);
                                else if (7 !== e)
                                    throw Error("unknown command " + e);
                            return[k, z, w, C]
                        }
                    }, {"point-geometry": 5}], 4: [function (a, c) {
                        function g(a, c) {
                            this.version = 1;
                            this.name = null;
                            this.extent = 4096;
                        ...
                        function k(a) {
                            for (var c = null, e = a.Ba() + a.ca; a.ca < e; )
                                c = a.Ba() >> 3, c = 1 === c ? a.Hf() :
                    ...
                    }, {"./vectortilefeature.js": 3}], 5: [function (a, c) {
                        function g(a, c) {
                            this.x = a;
                            this.y = c
                        }
    ...
    ht.prototype.Ea = function (a, c) {
        var d = this.f, e = new Tm(a), e = new Um.Mi(e), f = [], g = this.b, h, k, m;
        for (m in e.layers)
            if (!d || -1 != d.indexOf(m)) {
                h = e.layers[m];
    ...
    var lt = [null], mt = Q(lt, {nd: function (a, c) {
            c[c.length - 1].Qc.push(a.getAttribute("ref"))
        }, tag: kt}), ot = Q(lt, {node: function (a, c) {
            ...
            for (var d = c[0], e = a.getAttribute("id"), f = R({Qc: [], Ed: {}}, mt, a, c), g = c[c.length - 1], h = [], k = 0, m = f.Qc.length; k < m; k++)
                Ya(h, g.Og[f.Qc[k]]);
    ...
    var tt = [null, "http://www.opengis.net/ows/1.1"], st = Q(tt, {ServiceIdentification: N(function (a, c) {
            return R({}, ut, a, c)
        }), ServiceProvider: N(function (a, c) {
            return R({}, vt, a, c)
        }), OperationsMetadata: N(function (a, c) {
            return R({}, wt, a, c)
        })}), xt = Q(tt, {DeliveryPoint: N(W), City: N(W), AdministrativeArea: N(W), PostalCode: N(W), Country: N(W), ElectronicMailAddress: N(W)}), yt = Q(tt, {Value: Gm(function (a) {
            return W(a)
        })}), zt = Q(tt, {AllowedValues: N(function (a, c) {
            return R({}, yt, a, c)
        })}), Bt = Q(tt, {Phone: N(function (a, c) {
            return R({},
                    At, a, c)
        ...
        }), Post: void 0}), Ft = Q(tt, {DCP: N(function (a, c) {
            return R({}, Dt, a, c)
        })}), wt = Q(tt, {Operation: function (a, c) {
            var d = a.getAttribute("name"), e = R({}, Ft, a, c);
            e && (c[c.length - 1][d] = e)
        }}), At = Q(tt, {Voice: N(W), Facsimile: N(W)}), Et = Q(tt, {Constraint: Gm(function (a, c) {
            var d = a.getAttribute("name");
            return d ? R({name: d}, zt, a, c) : void 0
        })}),
            Gt = Q(tt, {IndividualName: N(W), PositionName: N(W), ContactInfo: N(function (a, c) {
                    return R({}, Bt, a, c)
                })}), ut = Q(tt, {Title: N(W), ServiceTypeVersion: N(W), ServiceType: N(W)}), vt = Q(tt, {ProviderName: N(W), ProviderSite: N(pt), ServiceContact: N(function (a, c) {
            return R({}, Gt, a, c)
        })});
    function Ht(a, c, d, e) {
        var f;
    ...
    l.zd = function (a, c) {
        var d = Pd(this.a), e = Lt(a, d, this.b);
        Ht(e, e.length, d, e);
        d = be(e, 0, e.length, d);
        ...
        if ("Topology" == a.type) {
            ...
            if (d) {
                ...
                for (m = g.length; k < m; ++k)
                    for (var n = g[k], p = d, q = h, r = 0, t = 0, v = void 0, w = void 0, z = void 0, w = 0, z = n.length; w < z; ++w)
    ...
    function Xt(a, c) {
        var d = {}, e = Tp(c.getAttribute("numberOfFeatures"));
        d.numberOfFeatures = e;
        return R(d, Yt, c, [], a.b)
    }
    var Zt = {"http://www.opengis.net/wfs": {totalInserted: N(Sp), totalUpdated: N(Sp), totalDeleted: N(Sp)}}, $t = {"http://www.opengis.net/ogc": {FeatureId: Em(function (a) {
                ...
                return R({}, Zt, a, c)
            }, "transactionSummary"), InsertResults: N(function (a, c) {
                return R([], au, a, c)
            }, "insertIds")}};
    function Ut(a) {
        for (a = a.firstChild; a; a = a.nextSibling)
    ...
    function cu(a, c) {
        var d = hm("http://www.opengis.net/ogc", "Filter"), e = hm("http://www.opengis.net/ogc", "FeatureId");
        d.appendChild(e);
        e.setAttribute("fid", c);
        a.appendChild(d)
    }
    var du = {"http://www.opengis.net/wfs": {Insert: O(function (a, c, d) {
                var e = d[d.length - 1], e = hm(e.featureNS, e.featureType);
                a.appendChild(e);
    ...
    Tt.prototype.A = function (a, c, d, e) {
        var f = [], g = hm("http://www.opengis.net/wfs", "Transaction");
        ...
        c && (k = {node: g, featureNS: e.featureNS, featureType: e.featureType,
            featurePrefix: e.featurePrefix}, mb(k, h), Nm(k, du, Im("Update"), c, f));
    ...
    var tu = {POINT: E, LINESTRING: T, POLYGON: F, MULTIPOINT: pp, MULTILINESTRING: U, MULTIPOLYGON: V}, su = {POINT: lu.prototype.vf, LINESTRING: lu.prototype.uf, POLYGON: lu.prototype.wf, MULTIPOINT: lu.prototype.yn, MULTILINESTRING: lu.prototype.xn, MULTIPOLYGON: lu.prototype.zn};
    function xu() {
        this.version = void 0
    }
    y(xu, qt);
    ...
    var Gu = [null, "http://www.opengis.net/wms"], yu = Q(Gu, {Service: N(function (a, c) {
            return R({}, Hu, a, c)
            ...
            return R({}, Lu, a, c)
        })}), Hu = Q(Gu, {Name: N(W), Title: N(W), Abstract: N(W), KeywordList: N(Eu), OnlineResource: N(pt), ContactInformation: N(function (a, c) {
            return R({}, Mu, a, c)
        }), Fees: N(W), AccessConstraints: N(W), LayerLimit: N(Sp), MaxWidth: N(Sp),
        MaxHeight: N(Sp)}), Mu = Q(Gu, {ContactPersonPrimary: N(function (a, c) {
            return R({}, Nu, a, c)
        }), ContactPosition: N(W), ContactAddress: N(function (a, c) {
            return R({}, Ou, a, c)
        }), ContactVoiceTelephone: N(W), ContactFacsimileTelephone: N(W), ContactElectronicMailAddress: N(W)}), Nu = Q(Gu, {ContactPerson: N(W), ContactOrganization: N(W)}), Ou = Q(Gu, {AddressType: N(W), Address: N(W), City: N(W), StateOrProvince: N(W), PostCode: N(W), Country: N(W)}), Ku = Q(Gu, {Format: Em(W)}), Lu = Q(Gu, {Name: N(W), Title: N(W), Abstract: N(W), KeywordList: N(Eu), CRS: Gm(W),
        EX_GeographicBoundingBox: N(function (a, c) {
            ...
            var c = [Rp(a.getAttribute("minx")), Rp(a.getAttribute("miny")), Rp(a.getAttribute("maxx")), Rp(a.getAttribute("maxy"))], d = [Rp(a.getAttribute("resx")), Rp(a.getAttribute("resy"))];
            return{crs: a.getAttribute("CRS"), extent: c, res: d}
        }), Dimension: Gm(function (a) {
            return{name: a.getAttribute("name"),
                units: a.getAttribute("units"), unitSymbol: a.getAttribute("unitSymbol"), "default": a.getAttribute("default"), multipleValues: Op(a.getAttribute("multipleValues")), nearestValue: Op(a.getAttribute("nearestValue")), current: Op(a.getAttribute("current")), values: W(a)}
        ...
        }), Identifier: Gm(W), MetadataURL: Gm(function (a, c) {
            var d = zu(a, c);
            if (d)
                return d.type = a.getAttribute("type"),
                d
        }), DataURL: Gm(zu), FeatureListURL: Gm(zu), Style: Gm(function (a, c) {
            return R({}, Ru, a, c)
        }), MinScaleDenominator: N(Qp), MaxScaleDenominator: N(Qp), Layer: Gm(function (a, c) {
            var d = c[c.length - 1], e = R({}, Lu, a, c);
            if (e) {
        ...
        })}), Qu = Q(Gu, {Title: N(W), OnlineResource: N(pt), LogoURL: N(Du)}), Pu = Q(Gu, {westBoundLongitude: N(Qp),
        eastBoundLongitude: N(Qp), southBoundLatitude: N(Qp), northBoundLatitude: N(Qp)}), Ju = Q(Gu, {GetCapabilities: N(Bu), GetMap: N(Bu), GetFeatureInfo: N(Bu)}), Cu = Q(Gu, {Format: Gm(W), DCPType: Gm(function (a, c) {
            return R({}, Su, a, c)
        })}), Su = Q(Gu, {HTTP: N(function (a, c) {
            return R({}, Tu, a, c)
        })}), Tu = Q(Gu, {Get: N(zu), Post: N(zu)}), Ru = Q(Gu, {Name: N(W), Title: N(W), Abstract: N(W), LegendURL: Gm(Du), StyleSheetURL: N(zu), StyleURL: N(zu)}), Au = Q(Gu, {Format: N(W), OnlineResource: N(pt)}), Fu = Q(Gu, {Keyword: Em(W)});
    function Uu(a) {
        a = a ? a : {};
    ...
    var Yu = [null, "http://www.opengis.net/wmts/1.0"], Zu = [null, "http://www.opengis.net/ows/1.1"], Wu = Q(Yu, {Contents: N(function (a, c) {
            return R({}, $u, a, c)
        })}), $u = Q(Yu, {Layer: Gm(function (a, c) {
            return R({}, av, a, c)
        }), TileMatrixSet: Gm(function (a, c) {
            return R({}, bv, a, c)
        })}), av = Q(Yu, {Style: Gm(function (a, c) {
            var d = R({}, cv, a, c);
            if (d) {
        ...
        }), Format: Gm(W), TileMatrixSetLink: Gm(function (a, c) {
            return R({}, dv, a, c)
        ...
        }), Identifier: N(W)})), cv = Q(Yu, {LegendURL: Gm(function (a) {
            var c = {};
            c.format = a.getAttribute("format");
            c.href = pt(a);
            return c
        })}, Q(Zu, {Title: N(W), Identifier: N(W)})), dv = Q(Yu, {TileMatrixSet: N(W)}),
            ev = Q(Yu, {Default: N(W), Value: Gm(W)}, Q(Zu, {Identifier: N(W)})), fv = Q(Zu, {LowerCorner: Em(Xu), UpperCorner: Em(Xu)}), bv = Q(Yu, {WellKnownScaleSet: N(W), TileMatrix: Gm(function (a, c) {
            return R({}, gv, a, c)
        })}, Q(Zu, {SupportedCRS: N(W), Identifier: N(W)})), gv = Q(Yu, {TopLeftCorner: N(Xu), ScaleDenominator: N(Qp), TileWidth: N(Sp), TileHeight: N(Sp), MatrixWidth: N(Sp), MatrixHeight: N(Sp)}, Q(Zu, {Identifier: N(W)}));
    function hv(a) {
        Mb.call(this);
        a = a || {};
        this.a = null;
    ...
    l = iv.prototype;
    l.clone = function () {
        var a = new iv(null), c = this.v.slice();
        Qd(a, this.f, c);
        a.u();
        return a
    };
    ...
    function kv(a, c, d) {
        for (var e = [], f = a(0), g = a(1), h = c(f), k = c(g), m = [g, f], n = [k, h], p = [1, 0], q = {}, r = 1E5, t, v, w, z, C; 0 < --r && 0 < p.length; )
    ...
    var ov = new Gk({color: "rgba(0,0,0,0.2)"}), pv = [90, 45, 30, 20, 10, 5, 2, 1, .5, .2, .1, .05, .01, .005, .002, .001];
    ...
    l.Hg = function (a) {
        ...
        if (!this.c || !Hd(this.c, g)) {
            var k = qd("EPSG:4326"), m = g.G(), n = g.i, p = Ld(n, k, g), q = n[2], r = n[1], t = n[0], v = p[3], w = p[2], z = p[1], p = p[0];
            this.i = n[3];
            this.g = q;
            this.j = r;
            this.f = t;
    ...
    vv.prototype.l = function (a, c) {
        var d = c.target.result, e = this.A, f = this.o;
        f || (f = e.$().i);
        var e = this.c, g = [], h, k;
        h = 0;
        for (k = e.length; h < k; ++h) {
    ...
    function Ev(a) {
        ...
        var c = a.$();
        Be(c, -1);
        var d = this.o - 1, e = c.Ka(), e = c.constrainRotation(e, 0);
        oj(a, c, e, void 0, void 0);
        var e = c.Z(), f = this.B, e = c.constrainResolution(e, 0, d);
        qj(a, c, e, void 0, f);
        this.o = 0;
        return!1
    }
        ...
        if (a.o) {
            ...
            if (e)
                for (var e = c.map, g = 0, h = f.length; g < h; g++) {
                    var k = f[g], m = e.Ta(k), n = c.pixel, d = n[0] - m[0], m = n[1] - m[1], n = a.U && a.oa(c) ? 1 : a.aj;
    ...
    function Pv(a, c) {
        var d = c.coordinate, e = a.o.X(), f, g;
        if (a.c === Nv)
    ...
    var Mv = "Point", Nv = "LineString", Lv = "Polygon", Sv = "Circle";
    function Wv(a, c, d) {
        Eb.call(this, a);
        this.features = c;
    ...
    function Xv(a) {
        ...
        this.aa = {Point: this.Zl, LineString: this.Zg, LinearRing: this.Zg,
            Polygon: this.$l, MultiPoint: this.Xl, MultiLineString: this.Wl, MultiPolygon: this.Yl, GeometryCollection: this.Vl};
        this.B = a.features;
    ...
    l.Zl = function (a, c) {
        var d = c.Y(), d = {feature: a, geometry: c, ka: [d, d]};
        this.a.za(c.G(), d)
    };
    l.Xl = function (a, c) {
        var d = c.Y(), e, f, g;
        f = 0;
        for (g = d.length; f < g; ++f)
            e = d[f], e = {feature: a, geometry: c, depth: [f], index: f, ka: [e, e]}, this.a.za(c.G(), e)
    };
    l.Zg = function (a, c) {
        var d = c.Y(), e, f, g, h;
        e = 0;
        for (f = d.length - 1; e < f; ++e)
            g = d.slice(e, e + 2), h = {feature: a, geometry: c, index: e, ka: g}, this.a.za(xc(g), h)
    };
    l.Wl = function (a, c) {
        ...
        for (k = d.length; h < k; ++h)
            for (e = d[h], f = 0, g = e.length - 1; f < g; ++f)
                m = e.slice(f, f + 2), n = {feature: a, geometry: c, depth: [h], index: f, ka: m}, this.a.za(xc(m), n)
    };
    l.$l = function (a, c) {
        var d = c.Y(), e, f, g, h, k, m, n;
        h = 0;
        ...
        for (n = d.length; m < n; ++m)
            for (p = d[m], h = 0, k = p.length; h < k; ++h)
                for (e = p[h], f = 0, g = e.length - 1; f < g; ++f)
                    q = e.slice(f, f + 2), r = {feature: a, geometry: c, depth: [h, m], index: f, ka: q}, this.a.za(xc(q), r)
    };
    l.Vl = function (a, c) {
        var d, e = c.i;
    ...
    function Yv(a) {
        ...
        var c = this.c;
        if (c) {
            var d = [], c = c.X().Y(), e = xc([c]), e = Zm(this.a, e), f = {};
            e.sort(hw);
    ...
    function Zv(a) {
        ...
        for (var c = 0, d = this.o.length; c < d; ++c) {
            for (var e = this.o[c], f = e[0], g = f.depth, h = f.geometry, k = h.Y(), m = f.ka, e = e[1]; a.length < h.qa(); )
                a.push(0);
            switch (h.W()) {
                case "Point":
                    k = a;
    ...
    function aw(a) {
        for (var c, d = this.o.length - 1; 0 <= d; --d)
    ...
    function cw(a, c, d) {
        ...
        var f = d.La(c), g = d.La([c[0] - a.H, c[1] + a.H]), h = d.La([c[0] + a.H, c[1] - a.H]), g = xc([g, h]), g = Zm(a.a, g);
        if (0 < g.length) {
            g.sort(e);
            var h = g[0].ka, k = cc(f, h), m = d.Ta(k);
    ...
    l.Rk = function (a, c) {
        for (var d = a.ka, e = a.feature, f = a.geometry, g = a.depth, h = a.index, k; c.length < f.qa(); )
            c.push(0);
        switch (f.W()) {
            case "MultiLineString":
                k = f.Y();
    ...
    function lw(a) {
        if (!this.J(a))
            return!0;
        var c = this.B(a), d = this.D(a), e = this.H(a), f = !c && !d && !e, g = a.map, h = this.c.da().c, k = [], m = [], n = !1;
        if (f)
    ...
    function nw(a) {
        Bj.call(this, {handleEvent: ow, handleDownEvent: fd, handleUpEvent: pw});
        a = a ? a : {};
    ...
    l = nw.prototype;
    l.rb = function (a, c) {
        var d = void 0 !== c ? c : !0, e = a.X(), f = this.aa[e.W()];
        if (f) {
            var g = x(a);
            this.U[g] = e.G(yc());
            f.call(this, a, e);
    ...
    l.nb = function (a, c) {
        var d = void 0 !== c ? c : !0, e = x(a), f = this.U[e];
        if (f) {
            var g = this.a, h = [];
            an(g, f, function (c) {
    ...
    l.bh = function (a, c) {
        ...
        e = 0;
        for (f = d.length - 1; e < f; ++e)
            g = d.slice(e, e + 2), h = {feature: a, ka: g}, this.a.za(xc(g), h)
    };
    l.gm = function (a, c) {
        var d = c.Y(), e, f, g, h, k, m, n;
        h = 0;
        for (k = d.length; h < k; ++h)
            for (e = d[h], f = 0, g = e.length - 1; f < g; ++f)
                m = e.slice(f, f + 2), n = {feature: a, ka: m}, this.a.za(xc(m), n)
    };
    l.hm = function (a, c) {
        var d = c.Y(), e, f, g;
        f = 0;
        for (g = d.length; f < g; ++f)
            e = d[f], e = {feature: a, ka: [e, e]}, this.a.za(c.G(), e)
    };
    l.im = function (a, c) {
        var d = c.Y(), e, f, g, h, k, m, n, p, q, r;
        m = 0;
        for (n = d.length; m < n; ++m)
            for (p = d[m], h = 0, k = p.length; h < k; ++h)
                for (e = p[h], f = 0, g = e.length - 1; f < g; ++f)
                    q = e.slice(f, f + 2), r = {feature: a, ka: q}, this.a.za(xc(q), r)
    };
    l.jm = function (a, c) {
        var d = c.Y(), d = {feature: a, ka: [d, d]};
        this.a.za(c.G(), d)
    };
    l.km = function (a, c) {
        var d = c.Y(), e, f, g, h, k, m, n;
    ...
    function ow(a) {
        var c, d, e = a.pixel, f = a.coordinate;
        c = a.map;
        var g = c.La([e[0] - this.c, e[1] + this.c]);
        d = c.La([e[0] + this.c, e[1] - this.c]);
        var g = xc([g, d]), h = Zm(this.a, g), k = !1, g = !1, m = null;
        d = null;
    ...
    y(rw, Eb);
    function sw(a) {
        Bj.call(this, {handleDownEvent: tw, handleDragEvent: uw, handleMoveEvent: vw, handleUpEvent: ww});
        this.s = void 0;
        this.a = null;
    ...
    l.qk = function () {
        for (var a = this.wg(), c = nh(1, 256), d = c.createLinearGradient(0, 0, 1, 256), e = 1 / (a.length - 1), f = 0, g = a.length; f < g; ++f)
    ...
    l.ef = function () {
        var a = this.eh(), c = this.og(), d = a + c + 1, e = 2 * d, e = nh(e, e);
    ...
    Aw.prototype.Bd = function () {
        ...
        this.g.forEach(function (c) {
            c && 2 == c.V() && a.push({extent: this.j.Da(c.ja), image: c.cb()})
        }, this);
        this.g.length = 0;
        if (0 === a.length)
            this.state = 3;
        else {
            var c = this.s[0], d = this.o.Ua(c), e = ia(d) ? d : d[0], d = ia(d) ? d : d[1], c = this.o.Z(c), f = this.j.Z(this.l), g = this.o.Da(this.s);
    ...
    function Dw(a, c, d, e, f, g) {
        var h = null, k = a.Db(c, d, e), m = a.af();
        if (lg(a.a, k)) {
    ...
    ;
    function Ew(a) {
        Y.call(this, {crossOrigin: "anonymous", opaque: !0, projection: qd("EPSG:3857"), reprojectionErrorThreshold: a.reprojectionErrorThreshold, state: "loading", tileLoadFunction: a.tileLoadFunction, wrapX: void 0 !== a.wrapX ? a.wrapX : !0});
    ...
    function Gw(a) {
        bn.call(this, {attributions: a.attributions, extent: a.extent, logo: a.logo, projection: a.projection, wrapX: a.wrapX});
        this.B = void 0;
    ...
    l.pd = function (a, c, d) {
        ...
        if (void 0 !== this.S) {
            var e = this.S, g = Yc(a), h = this.oa, k = Wc(a), m = Xc(a), n = f[0], p = f[1], q = .0254 / this.o, f = {OPERATION: this.ya ? "GETDYNAMICMAPOVERLAYIMAGE" : "GETMAPIMAGE", VERSION: "2.0.0", LOCALE: "en", CLIENTAGENT: "ol.source.ImageMapGuide source", CLIP: "1", SETDISPLAYDPI: this.o, SETDISPLAYWIDTH: Math.round(f[0]), SETDISPLAYHEIGHT: Math.round(f[1]),
    ...
    function Kw(a) {
        var c = void 0 !== a.attributions ? a.attributions : null, d = a.imageExtent, e = void 0 !== a.crossOrigin ? a.crossOrigin : null, f = void 0 !== a.imageLoadFunction ? a.imageLoadFunction : Vl;
    ...
    l.Bm = function (a, c, d, e) {
        if (void 0 !== this.j) {
            var f = Zc(a, c, 0, Nw), g = {SERVICE: "WMS", VERSION: "1.3.0", REQUEST: "GetFeatureInfo", FORMAT: "image/png", TRANSPARENT: !0, QUERY_LAYERS: this.i.LAYERS};
            mb(g, this.i, e);
    ...
    l.pd = function (a, c, d, e) {
        ...
        a = a.slice();
        var f = (a[0] + a[2]) / 2, g = (a[1] + a[3]) / 2, h = c / d, k = Wc(a) / h, h = Xc(a) / h, m = this.c;
        if (m && this.U == this.g && m.Z() == c && m.f == d && Gc(m.G(), a))
            return m;
        if (1 != this.o) {
            var m = this.o * Wc(a) / 2, n = this.o * Xc(a) / 2;
            a[0] = f - m;
            a[1] = g - n;
            a[2] = f + m;
            a[3] = g + n
    ...
    ;
    function Pw(a) {
        var c = void 0 !== a.projection ? a.projection : "EPSG:3857", d = void 0 !== a.tileGrid ? a.tileGrid : Hg({extent: Fg(c), maxZoom: a.maxZoom, tileSize: a.tileSize});
    ...
    y(Sw, Pw);
    var Uw = new Qe({html: 'Tiles Courtesy of <a href="http://www.mapquest.com/">MapQuest</a>'}), Tw = {osm: {maxZoom: 19, opaque: !0, attributions: [Uw, Rw]}, sat: {maxZoom: 18, opaque: !0, attributions: [Uw, new Qe({html: "Portions Courtesy NASA/JPL-Caltech and U.S. Depart. of Agriculture, Farm Service Agency"})]}, hyb: {maxZoom: 18, opaque: !1, attributions: [Uw, Rw]}};
        ...
        (function (d) {
            ...
            return function e(a, c, h) {
                ...
                return k
                        ...
                        function g(a) {
                            return function (c) {
                                var e = c.buffers, f = c.meta, g = c.width, h = c.height, k = e.length, m = e[0].byteLength, C;
                                if (c.imageOps) {
                                    m = Array(k);
                                    for (C = 0; C < k; ++C)
                        ...
                        function h(a, c) {
                            ...
                            }).concat(["var __minion__ = (" + g.toString() + ")(", a.operation.toString(), ");", 'self.addEventListener("message", function(__event__) {', "var buffer = __minion__(__event__.data);",
                        ...
                        m.prototype.Wf = function () {
                            if (0 === this.Ld && 0 < this.ad.length) {
                                var a = this.Pe = this.ad.shift(), c = a.wc[0].width, e = a.wc[0].height, f = a.wc.map(function (a) {
                                    return a.data.buffer
                                }), g = this.Nd.length;
                                this.Ld = g;
                                if (1 === g)
                                    this.Nd[0].postMessage({buffers: f, meta: a.fe,
                                        imageOps: this.Oe, width: c, height: e}, f);
                                else
                                    for (var h = 4 * Math.ceil(a.wc[0].data.length / 4 / g), k = 0; k < g; ++k) {
                                        for (var m = k * h, C = [], A = 0, B = f.length; A < B; ++A)
                        ...
                        m.prototype.Xi = function () {
                            var a = this.Pe, c = this.Nd.length, e, f;
                            if (1 === c)
    ...
    function Vw(a) {
        ...
        for (var c = Xw(this.c), d = {}, e = 0, f = c.length; e < f; ++e)
            d[x(c[e].layer)] = c[e];
        this.j = this.o = null;
        this.U = {animate: !1, attributions: {}, coordinateToPixelMatrix: nc(), extent: null, focus: null, index: 0, layerStates: d, layerStatesArray: c, logos: {},
            pixelRatio: 1, pixelToCoordinateMatrix: nc(), postRenderFunctions: [], size: [0, 0], skippedFeatureUids: {}, tileQueue: this.aa, time: Date.now(), usedTiles: {}, viewState: {rotation: 0}, viewHints: [], wantedTiles: {}};
        Pl.call(this, {});
        void 0 !== a.operation && this.s(a.operation, a.lib)
    }
    y(Vw, Pl);
    Vw.prototype.s = function (a, c) {
        this.H = new Vm.Hi({operation: a, Pk: "image" === this.ya, Kn: 1, lib: c, threads: this.qb});
        this.u()
    };
    function Yw(a, c, d) {
        var e = a.o;
    ...
    Vw.prototype.B = function (a, c, d, e) {
        ...
        var g = Yc(a), h = Math.round(Wc(a) / c), k = Math.round(Xc(a) / c);
        f.extent = a;
        f.focus = Yc(a);
        f.size[0] = h;
        f.size[1] = k;
    ...
    y($w, Eb);
    var ax = "beforeoperations", bx = "afteroperations";
    var cx = {terrain: {tb: "jpg", opaque: !0}, "terrain-background": {tb: "jpg", opaque: !0}, "terrain-labels": {tb: "png", opaque: !1}, "terrain-lines": {tb: "png", opaque: !1}, "toner-background": {tb: "png", opaque: !0}, toner: {tb: "png", opaque: !0}, "toner-hybrid": {tb: "png", opaque: !1}, "toner-labels": {tb: "png", opaque: !1}, "toner-lines": {tb: "png", opaque: !1}, "toner-lite": {tb: "png", opaque: !0}, watercolor: {tb: "jpg", opaque: !0}}, dx = {terrain: {minZoom: 4, maxZoom: 18}, toner: {minZoom: 0, maxZoom: 20}, watercolor: {minZoom: 3, maxZoom: 16}};
    function ex(a) {
        var c = a.layer.indexOf("-"), c = -1 == c ? a.layer : a.layer.slice(0, c), d = cx[a.layer];
    ...
    gx.prototype.qc = function (a, c, d) {
        ...
        e || (e = this.Za(d));
        if (!(e.Pb().length <= a[0])) {
            var f = e.Da(a, this.l), g = Sb(e.Ua(a[0]), this.j);
            1 != c && (g = Rb(g, c, this.j));
    ...
    function ix(a) {
        Ig.call(this, {opaque: !1, projection: a.projection, tileGrid: a.tileGrid, wrapX: void 0 !== a.wrapX ? a.wrapX : !0})
    }
    y(ix, Ig);
    ...
    function jx(a) {
        Y.call(this, {attributions: a.attributions, crossOrigin: a.crossOrigin, projection: qd("EPSG:3857"), reprojectionErrorThreshold: a.reprojectionErrorThreshold, state: "loading", tileLoadFunction: a.tileLoadFunction, wrapX: void 0 !== a.wrapX ? a.wrapX : !0});
        if (a.jsonp)
    ...
    function kx(a) {
        Ig.call(this, {projection: qd("EPSG:3857"), state: "loading"});
    ...
    l.Km = function (a, c, d, e) {
        ...
        c = f.Zd(a, c);
        if (!(f.Pb().length <= c[0])) {
            var g = f.Z(c[0]), h = f.Da(c, this.U), f = Sb(f.Ua(c[0]), this.j), k = this.s;
    ...
    l.qc = function (a, c, d) {
        ...
        if (!(e.Pb().length <= a[0])) {
            ...
            var f = e.Z(a[0]), g = e.Da(a, this.U), e = Sb(e.Ua(a[0]), this.j), h = this.s;
    ...
    function Z(a) {
        ...
        var e = this.aa = void 0 !== a.requestEncoding ? a.requestEncoding : "KVP", f = a.tileGrid, g = {layer: this.H, style: this.S, tilematrixset: this.s};
        "KVP" == e && mb(g, {Service: "WMTS", Request: "GetTile", Version: this.U, Format: this.A});
        var h = this.c, k = d && 0 < d.length ? rn(d.map(c)) : sn;
        Y.call(this, {attributions: a.attributions, crossOrigin: a.crossOrigin, logo: a.logo, projection: a.projection, reprojectionErrorThreshold: a.reprojectionErrorThreshold, tileClass: a.tileClass,
            tileGrid: f, tileLoadFunction: a.tileLoadFunction, tilePixelRatio: a.tilePixelRatio, tileUrlFunction: k, urls: d, wrapX: void 0 !== a.wrapX ? a.wrapX : !1})
    }
    y(Z, Y);
    l = Z.prototype;
    l.Aj = function () {
    ...
    function wx(a) {
        ...
        g.reverse();
        var c = [0, -c[1], c[0], 0], c = new ug({extent: c, origin: Sc(c), resolutions: g}), k = a.url;
    ...
    function yx(a, c, d, e, f, g) {
        var h = c ? a.i : a.c, k, m, n;
        m = 0;
        for (n = h.length; m < n; ++m) {
            k = h[m];
            a:{
                var p = k, q = d, r = e, t = f, v = g, w = void 0, z = void 0;
                k = void 0;
                z = 0;
    ...
    function Bx(a) {
        ...
        this.a && (h = Ze(this.a.b), k = this.a.a, void 0 === k && (k = 1), g = this.a.g, Ah || (g = null), e = this.a.c, void 0 === e && (e = "round"), d = this.a.f, void 0 === d && (d = "round"), f = this.a.i, void 0 ===
                f && (f = 10));
        var m = 2 * (this.g + k) + 1, d = {strokeStyle: h, Dd: k, size: m, lineCap: d, lineDash: g, lineJoin: e, miterLimit: f};
        if (void 0 === c) {
            ...
            m = Math.round(m), (e = !this.o) && (n = this.rh.bind(this, d)), f = this.a ? Hk(this.a) : "-", g = this.o ? Bk(this.o) : "-", this.c &&
    ...
    u("ol.animation.bounce", function (a) {
        var c = a.resolution, d = a.start ? a.start : Date.now(), e = void 0 !== a.duration ? a.duration : 1E3, f = a.easing ? a.easing : Ge;
        return function (a, h) {
            if (h.time < d)
                return h.animate = !0, h.viewHints[0] += 1, !0;
            if (h.time < d + e) {
    ...
    u("ol.loadingstrategy.tile", function (a) {
        return function (c, d) {
            var e = Dg(a, d), f = yg(a, c, e), g = [], e = [e, 0, 0];
    ...
    u("ol.render.toContext", function (a, c) {
        var d = a.canvas, e = c ? c : {}, f = e.pixelRatio || zh;
        if (e = e.size)
    ...
    u("ol.interaction.Draw.createRegularPolygon", function (a, c) {
        return function (d, e) {
            var f = d[0], g = d[1], h = Math.sqrt(hc(f, g)), k = e ? e : ve(new iv(f), a);
